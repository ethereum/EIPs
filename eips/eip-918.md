...
[extra]
eip = 918
author = [{ name = "Jay Logelin", email = "jlogelin@alumni.harvard.edu" }, { name = "Infernal_toast", email = "admin@0xbitcoin.org" }, { name = "Michael Seiler", email = "mgs33@cornell.edu" }, { name = "Brandon Grill", email = "bg2655@columbia.edu" }]
status = "Draft"
