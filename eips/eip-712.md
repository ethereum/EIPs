...
[extra]
eip = 712
author = [{ name = "Remco Bloemen", email = "remco@wicked.ventures" }, { name = "Leonid Logvinov", email = "logvinov.leon@gmail.com" }, { name = "Jacob Evans", email = "jacob@dekz.net" }]
discussions_to = "https://ethereum-magicians.org/t/eip-712-eth-signtypeddata-as-a-standard-for-machine-verifiable-and-human-readable-typed-data-signing/397"
status = "Draft"
