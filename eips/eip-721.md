...
[extra]
eip = 721
author = [{ name = "William Entriken", email = "github.com@phor.net" }, { name = "Dieter Shirley", email = "dete@axiomzen.co" }, { name = "Jacob Evans", email = "jacob@dekz.net" }, { name = "Nastassia Sachs", email = "nastassia.sachs@protonmail.com" }]
