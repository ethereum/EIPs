...
[extra]
eip = 2021
author = [{ name = "Fernando Paris", email = "fer@io.builders" }, { name = "Julio Faura", email = "julio@adhara.io" }, { name = "Daniel Lehrner", email = "daniel@io.builders" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/2106"
status = "Draft"
