...
[extra]
eip = 2771
author = [{ name = "Ronan Sandford", github = "wighawag" }, { name = " Liraz Siri", github = "lirazsiri" }, { name = " Dror Tirosh", github = "drortirosh" }, { name = " Yoav Weiss", github = "yoavw" }, { name = " Alex Forshtat", github = "forshtat" }, { name = " Hadrien Croubois", github = "Amxx" }, { name = " Tomar Sachin", github = "tomarsachin2271" }, { name = " Patrick McCorry", github = "stonecoldpat" }, { name = " Nicolas Venturo", github = "nventuro" }, { name = " Fabian Vogelsteller", github = "frozeman" }]
discussions_to = "https://ethereum-magicians.org/t/eip-2771-secure-protocol-for-native-meta-transactions"
status = "Draft"
