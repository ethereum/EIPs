...
[extra]
eip = 1155
author = [{ name = "Witek Radomski", email = "witek@enjin.io" }, { name = "Andrew Cooke", email = "ac0dem0nk3y@gmail.com" }, { name = "Philippe Castonguay", email = "pc@horizongames.net" }, { name = "James Therien", email = "james@turing-complete.com" }, { name = "Eric Binet", email = "eric@enjin.io" }, { name = "Ronan Sandford", email = "wighawag@gmail.com" }]
