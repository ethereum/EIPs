...
An extension to the JavaScript Ethereum Provider API ([EIP-1193](@/EIPS/eip-1193.md)) this creates a new message type in the event a transaction replacement occurs.
