...
[extra]
eip = 615
author = [{ name = "Greg Colvin", email = "greg@colvin.org" }, { name = " Brooklyn Zelenka", github = "expede" }, { name = " Paweł Bylica", github = "chfast" }, { name = " Christian Reitwiessne", github = "chriseth" }]
discussions_to = "https://ethereum-magicians.org/t/eip-615-subroutines-and-static-jumps-for-the-evm-last-call/3472"
status = "Draft"
