...
[extra]
eip = 1057
author = [{ name = "Greg Colvin", email = "greg@colvin.org" }, { name = " Andrea Lanfranchi", github = "AndreaLanfranchi" }, { name = " Michael Carter", github = "bitsbetrippin" }, { name = "IfDefElse", email = "ifdefelse@protonmail.com" }]
discussions_to = "https://ethereum-magicians.org/t/eip-progpow-a-programmatic-proof-of-work/272"
status = "Accepted"
