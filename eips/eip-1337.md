...
[extra]
eip = 1337
author = [{ name = "Kevin Owocki", email = "kevin@gitcoin.co" }, { name = "Andrew Redden", email = "andrew@blockcrushr.com" }, { name = "Scott Burke", email = "scott@blockcrushr.com" }, { name = "Kevin Seagraves", email = "k.s.seagraves@gmail.com" }, { name = "Luka Kacil", email = "luka.kacil@gmail.com" }, { name = "Štefan Šimec", email = "stefan.simec@gmail.com" }, { name = " Piotr Kosiński", github = "kosecki123" }, { name = "ankit raj", email = "tradeninja7@gmail.com" }, { name = "John Griffin", email = "john@atchai.com" }, { name = "Nathan Creswell", email = "nathantr@gmail.com" }]
discussions_to = "https://ethereum-magicians.org/t/eip-1337-subscriptions-on-the-blockchain/4422"
status = "Draft"
