...
[extra]
eip = 152
author = [{ name = "Tjaden Hess", email = "tah83@cornell.edu" }, { name = " Matt Luongo", github = "mhluongo" }, { name = " Piotr Dyraga", github = "pdyraga" }, { name = " James Hancock", github = "MadeOfTin" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/152"
status = "Final"
