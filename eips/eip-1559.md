...
[extra]
eip = 1559
author = [{ name = "Vitalik Buterin", github = "vbuterin" }, { name = " Eric Conner", github = "econoar" }, { name = " Rick Dudley", github = "AFDudley" }, { name = " Matthew Slipper", github = "mslipper" }, { name = " Ian Norden", github = "i-norden" }]
