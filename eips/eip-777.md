...
[extra]
eip = 777
author = [{ name = "Jacques Dafflon", email = "mail@0xjac.com" }, { name = "Jordi Baylina", email = "jordi@baylina.cat" }, { name = "Thomas Shababi", email = "tom@truelevel.io" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/777"
status = "Final"
