...
[extra]
eip = 2028
author = [{ name = "Alexey Akhunov", github = "AlexeyAkhunov" }, { name = "Eli Ben Sasson", email = "eli@starkware.co" }, { name = "Tom Brand", email = "tom@starkware.co" }, { name = "Louis Guthmann", email = "louis@starkware.co" }, { name = "Avihu Levy", email = "avihu@starkware.co" }]
discussions_to = "https://ethereum-magicians.org/t/eip-2028-calldata-gas-cost-reduction/3280"
status = "Final"
