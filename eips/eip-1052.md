...
[extra]
eip = 1052
author = [{ name = "Nick Johnson", email = "arachnid@notdot.net" }, { name = "Paweł Bylica", email = "pawel@ethereum.org" }]
discussions_to = "https://ethereum-magicians.org/t/extcodehash-opcode/262"
status = "Final"
