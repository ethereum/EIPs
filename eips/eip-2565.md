...
[extra]
eip = 2565
author = [{ name = "Kelly Olson", github = "ineffectualproperty" }, { name = " Sean Gulley", github = "sean-sn" }, { name = " Simon Peffers", github = "simonatsn" }, { name = " Justin Drake", github = "justindrake" }, { name = " Dankrad Feist", github = "dankrad" }]
discussions_to = "https://ethereum-magicians.org/t/big-integer-modular-exponentiation-eip-198-gas-cost/4150"
status = "Last Call"
type = "Standards Track"
category = "Core"
created = 2020-03-20
requires = "198"
review_period_end = "2020-07-31"
+++
