...
[extra]
eip = 1504
author = [{ name = "Kaidong Wu", email = "wukd94@pku.edu.cn" }, { name = "Chuqiao Ren", email = "cr025@bucknell.edu" }, { name = "Ruthia He", email = "rujiahe@gmail.com" }, { name = "Yun Ma", email = "mayun@pku.edu.cn" }, { name = "Xuanzhe Liu", email = "liuxuanzhe@pku.edu.cn" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/1503"
status = "Draft"
