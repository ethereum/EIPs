...
[extra]
eip = 1271
author = [{ name = "Francisco Giordano", github = "frangio" }, { name = " Matt Condon", github = "shrugs" }, { name = " Philippe Castonguay", github = "PhABC" }, { name = " Amir Bandeali", github = "abandeali1" }, { name = " Jorge Izquierdo", github = "izqui" }, { name = " Bertrand Masius", github = "catageek" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/1271"
status = "Draft"
