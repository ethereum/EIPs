...
[extra]
eip = 1450
author = [{ name = "John Shiple", github = "johnshiple" }, { name = "Howard Marks", email = "howard@startengine.com" }, { name = "David Zhang", email = "david@startengine.com" }]
discussions_to = "https://ethereum-magicians.org/t/erc-proposal-ldgrtoken-a-compatible-security-token-for-issuing-and-trading-sec-compliant-securities/1468"
status = "Draft"
