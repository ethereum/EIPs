...
[extra]
eip = 165
author = [{ name = "Christian Reitwießner", email = "chris@ethereum.org" }, { name = "Nick Johnson", email = "nick@ethereum.org" }, { name = "Fabian Vogelsteller", email = "fabian@lukso.network" }, { name = "Jordi Baylina", email = "jordi@baylina.cat" }, { name = "Konrad Feldmeier", email = "konrad.feldmeier@brainbot.com" }, { name = "William Entriken", email = "github.com@phor.net" }]
status = "Final"
