...
[extra]
eip = 1761
author = [{ name = "Witek Radomski", email = "witek@enjin.io" }, { name = "Andrew Cooke", email = "ac0dem0nk3y@gmail.com" }, { name = "James Therien", email = "james@enjin.io" }, { name = "Eric Binet", email = "eric@enjin.io" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/1761"
status = "Draft"
