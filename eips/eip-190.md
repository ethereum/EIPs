...
[extra]
eip = 190
author = [{ name = "Piper Merriam", github = "pipermerriam" }, { name = " Tim Coulter", github = "tcoulter" }, { name = " Denis Erfurt", github = "mhhf" }, { name = " RJ Catalano", github = "VoR0220" }, { name = " Iuri Matias", github = "iurimatias" }]
status = "Final"
