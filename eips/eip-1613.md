...
[extra]
eip = 1613
author = [{ name = "Yoav Weiss", email = "yoav@tabookey.com" }, { name = "Dror Tirosh", email = "dror@tabookey.com" }, { name = "Alex Forshtat", email = "alex@tabookey.com" }]
discussions_to = "https://github.com/yoav-tabookey/EIPs/issues/1"
status = "Draft"
