...
[extra]
eip = 1890
author = [{ name = "Gregory Markou", email = "greg@chainsafe.io" }, { name = "Kevin Owocki", email = "kevin@gitcoin.co" }, { name = "Lane Rettig", email = "lane@ethereum.org" }]
discussions_to = "https://t.me/joinchat/DwEd_xahL5hHvzNYH2RnQA"
status = "Draft"
