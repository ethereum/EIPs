...
[extra]
eip = 695
author = [{ name = "Isaac Ardis", email = "isaac.ardis@gmail.com" }, { name = " Wei Tang", github = "sorpaas" }, { name = " Fan Torchz", github = "tcz001" }, { name = " Erik Marks", github = "rekmarks" }]
discussions_to = "https://ethereum-magicians.org/t/eip-695-create-eth-chainid-method-for-json-rpc/1845"
status = "Final"
