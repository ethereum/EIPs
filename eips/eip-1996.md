...
[extra]
eip = 1996
author = [{ name = "Julio Faura", email = "julio@adhara.io" }, { name = "Fernando Paris", email = "fer@io.builders" }, { name = "Daniel Lehrner", email = "daniel@io.builders" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/2103"
status = "Draft"
