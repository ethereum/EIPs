...
[extra]
eip = 820
author = [{ name = "Jordi Baylina", email = "jordi@baylina.cat" }, { name = "Jacques Dafflon", email = "jacques@dafflon.tech" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/820"
status = "Superseded"
