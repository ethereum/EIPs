...
[extra]
eip = 1319
author = [{ name = "Piper Merriam", email = "piper@ethereum.org" }, { name = "Christopher Gewecke", email = "christophergewecke@gmail.com" }, { name = "g. nicholas d'andrea", email = "nick.dandrea@consensys.net" }, { name = "Nick Gheorghita", email = "nickg@ethereum.org" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/1319"
status = "Draft"
