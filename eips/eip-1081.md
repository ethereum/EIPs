...
[extra]
eip = 1081
author = [{ name = "Mark Beylin", email = "mark.beylin@consensys.net" }, { name = "Kevin Owocki", email = "kevin.owocki@consensys.net" }, { name = " Ricardo Guilherme Schmidt", github = "3esmit" }]
discussions_to = "https://gitter.im/bounties-network/Lobby"
status = "Draft"
