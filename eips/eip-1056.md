...
[extra]
eip = 1056
author = [{ name = "Pelle Braendgaard", email = "pelle.braendgaard@consensys.net" }, { name = "Joel Torstensson", email = "oed@consensys.net" }]
discussions_to = "https://github.com/ethereum/EIPs/issues/1056"
status = "Draft"
