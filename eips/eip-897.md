...
[extra]
eip = 897
author = [{ name = "Jorge Izquierdo", email = "jorge@aragon.one" }, { name = "Manuel Araoz", email = "manuel@zeppelin.solutions" }]
discussions_to = "https://github.com/ethereum/EIPs/pull/897"
status = "Draft"
