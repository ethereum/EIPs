...
[extra]
eip = 1716
author = [{ name = "Afri Schoedon", github = "5chdn" }, { name = " Marius van der Wijden", github = "MariusVanDerWijden" }]
status = "Final"
type = "Meta"
created = 2019-01-21
requires = "1013, 1283"
...
This meta-EIP specifies the changes included in the Ethereum hardfork that removes [EIP-1283](@/EIPS/eip-1283.md) from [Constantinople](@/EIPS/eip-1013.md).
...
- Removed EIPs:
  - [EIP 1283](@/EIPS/eip-1283.md): Net gas metering for SSTORE without dirty maps
