...
[extra]
eip = 1753
author = [{ name = "Lucas Cullen", github = "BitcoinBrisbane" }, { name = " Kai Yeung", github = "CivicKai" }, { name = "Anna Crowley", email = "annaelizabethcrowley@gmail.com" }, { name = "Caroline Marshall", email = "caroline.marshall888@gmail.com" }, { name = "Katrina Donaghy", email = "katrina@civicledger.com" }]
status = "Draft"
