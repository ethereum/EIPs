...
author: <a comma separated list of the author's or authors' name + GitHub username (in parenthesis), or name and email (in angle brackets).  Example, FirstName pddiffer053 (@GitHubUsername), FirstName LastName <foo@bar.com>, FirstName (@pddiffer053)(@pddiffer053)>
discussions-to: <URL>
status: Draft
