...
| ---- | -------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------- | -------------- | ------ | --------------- | -------- | --------- | -------- |
| 4966 | Authorization standard based on ERC721 | NFT owners can authorize other users to use their NFTs for business purpose. | VeegaLabs Official (@VeegaLabs100), <kccinfo100@gmail.com> | #4966          | Draft  | Standards Track | ERC      | 15-8-2022 | 721      |
