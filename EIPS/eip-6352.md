...
Tests can be found under [test/](../assets/eip-6352/test/) folder.

## Reference Implementation

The reference implementation of the standard can be found under [contracts/](../assets/eip-6352/contracts/) folder.
