...
Dynamic jumps also impede the validation of safety properties promised by [EIP-3779](./eip-3779.md): that no valid program will encounter an exceptional halting condition except via lack of gas or recursive stack overflow. 
