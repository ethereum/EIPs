---
eip: 107
title: Safer eth_sendTransaction popup auth
description: Authorize eth_sendTransaction via HTML popup
...
<html>
  ...
  <script>
    // github.com/alexvandesande/blockies
    ...
    /* bignumber.js v2.3.0 (see github.com/MikeMcl/bignumber.js/LICENCE) */
...
This proposal relies on browser same-origin policies and `window.postMessage` security guarantees. Implementations must validate message origins and payloads, and should minimize exposed RPC methods in iframe mode to reduce the risk of phishing or unauthorized requests.
