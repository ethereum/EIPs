...
The smart contract wallet interface of this EIP is for asset management and asset approval. It supports the new asset EIP-7196, and [ERC-20](./eip-20.md) is backward compatible with EIP-7196, so it can be compatible with the management of all fungible tokens in the existing market.
...
**Every ERC-7204 compliant contract must implement the ERC-7204 and [ERC-165](./eip-165) interfaces**
