...
### [ERCXXXX] Singleton Factory

> This is an exact copy of the code of the [ERCXXXX factory smart contract].
...
contract SingletonFactory {
     ...
     * @param _initCode contract init code
     */
    function deploy(
...
```

```

The strings of `XXXX`'s at the end of the transaction are the `r` and `s` of the signature.
...
2. Set the `v`, `r`, `s` of the transaction signature to the following values:
   ...
   ```
   v: 27,
   r: 0xXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
   s: 0xXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
   ```

   Those `r` and `s` values---made of a repeating pattern of `XXXX`'s---are predictable "random numbers" generated deterministically by a human.
...
<details>
<summary>Raw metadata of <code>./contracts/ERCXXXXSingletonFactory.sol</code></summary>
<pre>
<code>
[
	{
