...
The alternative to checking validity at creation time is checking it at runtime.  This hurts performance and is a DoS surface.  Thus the above rules and accompanying validation algorithm.
