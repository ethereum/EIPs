...
> Define `JUMP` and `JUMPI` as `INVALID` for the purposes of [EIP-3670: EOF Code Validation](./eip-3670.md).
...
*Choosing whether to deprecate `JUMP` and `JUMPI` remains under active discusion.*
