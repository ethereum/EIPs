...
This standard is an extension to NFT metadata JSON schema defined by [EIP-721](./eip-721.md) and [EIP-1155](./eip-1155.md). As a complement, it provides additional information about how the NFT asset is stored in a decentralized storage system, if applicable.
...
An example of an [EIP-721](./eip-721.md) NFT asset Metadata JSON file follows. The `dStorage` property contains information about how the NFT asset is stored on Crust Network, which can be verified on https://ipfs-scan.io?cid=QmVvigK7jfLyHcDjnNYr2mAReFW9FCFWf41UNB9tbK8rWw.
