...
All-of-the-above are bad UX, and we believe the `ERC721` standard can be improved by adopting a native locking mechanism:
...
Lockable `ERC721` **MUST** implement the `IERC721Lockable` interfaces:
