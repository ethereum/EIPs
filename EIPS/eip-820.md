...
This contract is going to be deployed using the keyless deployment method&mdash;also known as [Nick]'s method&mdash;which relies on a single-use address. (See [Nick's article] for more details). This method works as follows:
