...
This EIP is specified against the JSON-RPC transport of the engine API. This section is non-normative and records the intended mapping onto the REST/Simple Serialize (SSZ) engine API transport proposed in [`engine: add Rest-SSZ spec`](https://github.com/ethereum/execution-apis/pull/793):
