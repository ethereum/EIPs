...
The following table shows a summary of the typicall values for keys and the approximate amount of time taken per second to execute signature verifications as specified by the authors of Falcon in https://falcon-sign.info/
...
- The reference implementation for the precompiled signature using Falcon can be found for the Go-Ethereum cliet at https://github.com/lacchain/go-ethereum/pull/2/files
- The reference iplementation for Hyperledger Besu Client can be found for Besu Client at https://github.com/hyperledger/besu/compare/main...lacchain:besu:falcon_precompiled?expand=1
