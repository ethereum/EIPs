...
Editors may delegate mechanical administrative work to Coordinators as described under [Membership](#membership).
...
In addition to the general membership requirements above, EIP Coordinators are expected to demonstrate:
