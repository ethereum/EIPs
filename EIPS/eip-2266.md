...
+ The `initiateTimestamp` should cover the whole swap process, and hence the largest.
+ The participant should never participate before checking the premium has been deposited.
