...
- SHOULD query the Registry on module installation
- SHOULD query the Registry on module execution
- MAY evaluate the listedAt timestamp for vendor specific attestation age criteria
...
Revocations MUST be permanent. To "unrevoke" an attestation, a new attestation has to be issued.
