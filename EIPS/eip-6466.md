...
category: Core
created: 2023-02-08
requires: 658, 2718, 6404, 7495, 7668, 7702, 7916, 8016, NEW
---
...
The `logs_bloom`, intermediate state `root` (Homestead scheme), and `cumulative_gas_used` (pre [EIP-NEW](./eip-template.md)) fields are not present in SSZ receipts.
