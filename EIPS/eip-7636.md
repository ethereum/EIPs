...
All elements MUST be encoded as a string using the ASCII standard.

The value for this entry MUST be a RLP list:
...
Using many keys or one string was decided to either be space inefficient or it does not align with other EIPs of similar purpose and as such the RLP list was decided as the best case.
