...
Testnets that use Proof-of-Authority do not have a difficulty adjusting algorithm, nor an Ice Age mechanism. Because this fork explicitly deals only with the Ice Age, it does not need to be rolled out on the POA Testnets. 
