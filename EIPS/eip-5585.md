...
If a NFT owner sold his NFT with an authorization, we need to make sure the new onwer can have the rest authorization fee and will not cancel the authorization.
