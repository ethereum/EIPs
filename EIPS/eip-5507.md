...
interface ERC20Refund is ERC20, ERC165 {
    ...
    /// @param  _sender   The account that requested a refund
...
[ERC-165](./eip-165.md) is required as introspection by DApps would be made significantly harder if it weren't.

Custom ERC-20 tokens are not supported, as it needlessly increases complexity.
