...
discussions-to: https://ethereum-magicians.org/t/eip-8000-available-attestation-a-reorg-resilient-solution-for-ethereum/23927
status: Draft
...
For the validator behavior specification ([validator.md in consensus-specs](https://github.com/ethereum/consensus-specs/blob/dev/specs/phase0/validator.md)):
...
For the fork choice specification ([fork_choice.md in consensus-specs](https://github.com/ethereum/consensus-specs/blob/dev/specs/phase0/fork-choice.md)):
