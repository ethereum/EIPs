...
Gas cost of these new opcodes is similar to the legacy counterpart `CODECOPY`. These new instructions need to be carefully considered during implementation of EOF container validation algorithm.
