...
References:
 ...
 - [MM]: MetaMask API Method Deprecation. <link omitted, because of HTML Proofer issues>
 - [L]: `LedgerHQ / app-ethereum` pull request #240: Add `EIP 1024` APDUs. <link omitted, because of HTML Proofer issues>
