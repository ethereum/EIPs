...
Our proposal should be viewed as a successor to [#1098], which has stagnated. That EIP received some support. It was implemented, and subsequently deprecated, by MetaMask [MM API]; it was also implemented by Ledger [L#240].
...
###References:
 ...
 - [MM API]: MetaMask API Method Deprecation. https://medium.com/metamask/metamask-api-method-deprecation-2b0564a84686
 ...
 - [L#240]: `LedgerHQ / app-ethereum` pull request 240: Add `EIP 1024` APDUs. https://github.com/LedgerHQ/app-ethereum/pull/240
