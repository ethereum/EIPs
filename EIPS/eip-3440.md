...
discussions-to: https://github.com/ethereum/eips/issues/3440
status: Draft
...
## Motivation
Currently the link between a NFT and the digital work of art is only enforced in the token metadata stored in the shared `tokenURI` state of a NFT. 
