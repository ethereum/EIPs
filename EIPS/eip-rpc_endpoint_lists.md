---
eip: <to be assigned> <!-- Don't forget to update the $id field -->
...
The list MUST conform to the following JSON Schema:
...
List versioning MUST follow the [Semantic Versioning 2.0.0](../assets/eip-rpc_endpoint_lists.md) (SemVer) specification.
