...
- spend: The new method on the ER-C20 to transfer tokens, call the receiver, and handle returned arguments.
...
{ERC20Spendable} allows ERC-20s to operate as 'spendable' items, i.e. an ERC-20 token that
...
See {IERC165-supportsInterface}. This can be used to determine if an ERC-20 is ERC20Spendable. For
