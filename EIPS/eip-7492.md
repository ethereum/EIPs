...
can trigger an action on another contract at the same time as being transfered. Similar to [ERC-677](../../issues/677.html)
and the hooks in [ERC-777](./eip-777.md), but with more of an empasis on interoperability (returned values) than
[ERC-677](../../issues/677.html) and specifically scoped interaction rather than the general hooks of [ERC-777](./eip-777.md).
