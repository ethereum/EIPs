...
Low-Cost Security: The cost of using **KBTs**[^1] security features correlate to on-chain fees, the current **GWEI** at the given time. As a standalone solution, they are a viable cost-effective security measure feasible to the majority of the population.
