...
[EIP-1559](https://eips.ethereum.org/EIPS/eip-1559) transaction type 2 is updated so that clients can send a contract's code as part of a transaction, just the same way as now how clients can send state variables.
