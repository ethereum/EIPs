...
This ERC proposes a new extension of NFT (non-fungible token, aka ERC-721): nft-hyperlink-extention (hNFT), which embedded hyperlinks in NFTs. With hHNFT, the owners of NFTs can authorize a URL slot to a specific address which can be either an externally-owned account (EOA) or a contract account and they are entitled to revoke that authorization as well. Address which got slot authorization, can manage the URI on the slot.
...
Ironman, "EIP-5438: hNFT, ERC-721 Hyperlink Extension," Ethereum Improvement Proposals, no. 5438, August 2022. [Online serial]. Available: https://eips.ethereum.org/EIPS/eip-5438.