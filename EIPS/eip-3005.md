...
> 
> Both of these examples are very impractical and are not useful in reality. But the gas usage tests for both were made anyway (Test 2 and 3, respectively) and can be found in the [calculateGasCosts.js](https://github.com/defifuture/erc20-batched-meta-transactions/blob/master/test/calculateGasCosts.js) file in the test folder.
...
![](../assets/eip-3005/batched-meta-txs-gas-usage-1st-2nd.png)
...
![](../assets/eip-3005/on-chain_vs_M-to-M_vs_M-to-1_gas-cost-structure.png)
