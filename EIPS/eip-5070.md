...
The total amount of underlying that is "managed" by the Principal Token contract and will need to be paid out upon maturity.

OPTIONAL - This method can be used to provide needed data for the calculation of interest post-maturity, and solvency of the Principal Token contract but interfaces and other contracts MUST NOT expect this method to be present.

MUST include any compounding that occurs from yield post-maturity for Yield Tokenized Principal Tokens.
