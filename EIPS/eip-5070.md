...
The Principal Token has hit maturity, and a user has interacted with the Principal Token contract for the first time post-maturity, calling the `mature` method.
