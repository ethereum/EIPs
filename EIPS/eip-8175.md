...
The address is verified by checking the signature against the account's Ed25519 public key, following the verification requirements from EIP-8164.
...
6. For ED25519 signatures, the signature MUST follow the verification requirements from EIP-8164.
