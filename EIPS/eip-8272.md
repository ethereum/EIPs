...
`RECENT_ROOT_ADDRESS` MUST differ from EIP-8141's `EXPIRY_VERIFIER`. If [EIP-8250](./eip-8250.md) is active, `RECENT_ROOT_ADDRESS` MUST also differ from `NONCE_MANAGER`.
