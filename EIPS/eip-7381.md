...
> :information_source: **[ERC-7381](./eip-7381.md) has superseded [ERC-6381](./eip-6381.md).** :information_source:  
> [ERC-7381](./eip-7381.md) fixes the compatibility issue in the [ERC-6381](./eip-6381.md) interface specification, where the UNIX emotjis are represented using `bytes4` values. The introduction of variation flags and emoji skin tones has rendered the `bytes4` namespace insufficient for representing all possible emojis, so the new standard used `string` instead.
> Apart from this fix, [ERC-7381](./eip-7381.md) is functionally equivalent to [ERC-6381](./eip-6381.md).
>
> :warning: [ERC-7381](./eip-7381.md) MUST be used in lieu of [ERC-6381](./eip-6381.md). :warning:
...
```solidity
/// @title ERC-7381 Emotable Extension for Non-Fungible Tokens
/// @dev See https://eips.ethereum.org/EIPS/eip-7381
...
Tests are included in [`emotableRepository.ts`](../assets/eip-7381/test/emotableRepository.ts).
...
See [`EmotableRepository.sol`](../assets/eip-7381/contracts/EmotableRepository.sol).
