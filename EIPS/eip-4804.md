...
The protocol will find the address of **vitalikblog.eth** from ENS on chainid 5 (Rinkeby), and then call the address with "From" = "0x..." and "Calldata" = "0x2F" with chainid = 5.
