...
Note that `web3` text record may return an Ethereum address or an EIP-3770 chain-specific address.  If the address is an EIP-3770 chain-specific address, then the chainid to call the message will be overriden by the chainid specified by the EIP-3770 address.
