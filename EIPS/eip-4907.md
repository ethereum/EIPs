...
### Contract Interface
Solidity Interface with NatSpec & OpenZeppelin v4 Interfaces (also available at [`IEIP4907.sol`](../assets/eip-4907/contracts/IERC4907.sol)):
...
### Test Contract
EIP-4907Demo Implementation: [`EIP4907Demo.sol`](../assets/eip-4907/contracts/ERC4907Demo.sol)
...
EIP-4907 Implementation: [`ERC4907.sol`](../assets/eip-4907/contracts/ERC4907.sol)
```solidity
// SPDX-License-Identifier: CC0-1.0
pragma solidity ^0.8.0;
