...
eip: 5131
<<<<<<< HEAD
title: Secondary Authentication For ENS (SAFE)
...
>>>>>>> 1ae8d3b0aca15214640445baa92791974041d850
...
4. Using `mainAddress` configure the `eip5131:<authKey>` (this can be any string in the format `[0-0A-Za-z]+`) TEXT record of `mainENS` to `authAddress`
5. Using `authAddress`, set the `eip5131:vault` TEXT record to `authENS` to `<authKey>:<mainAddress>`
>>>>>>> 1ae8d3b0aca15214640445baa92791974041d850
