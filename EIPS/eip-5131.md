...
### Solidity
In solidity, the validation signature could look like:
```
/**
...
This can be an internal validate function to the smart contract, that is used in conjunction with specs like EIP-1721: Standard Signature Validation Method for Contracts and Merkle Proof Verification.
