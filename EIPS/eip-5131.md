...
This is made possible because the attendee completed the necessary upfront ENS configuration with the cold storage device to allow the 'hot wallet' to be used for this operation. 
...
### One-to-Many Authenitcation Relationship
