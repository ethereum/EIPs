...
**contracts that want to represent a work on chain MUST implement EIP-721 AND this Proposal**
...
With this proposal, we allow multiple **types** of royalty interests. A classic case is the music industry in which you have writing/composition royalties, and recording/master royalties. Different licensing types will pay different precentages to different parties based on context.
