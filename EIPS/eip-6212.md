...
To create and deploy an [EIP-6212](./eip-6212.md) contract one **MAY** only inherit directly from this [EIP-721](./eip-721.md) extension that would directly signal support for EIP-6212:
...
Tests can be found under [test/](../assets/eip-6212/test/) folder.

## Reference Implementation

Contract implementation can be found under [contracts/](../assets/eip-6212/contracts/) folder.
