...
- New accounts SHOULD be deployed as [EIP-1167](./eip-1167.md) proxies and ownership SHOULD be assigned to the initial owner
...
- Account Instance SHOULD support [EIP-1271](./eip-1271.md)
