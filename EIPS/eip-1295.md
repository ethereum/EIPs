...
Starting with CNSTNTNPL_FORK_BLKNUM the client will calculate the difficulty with a fake block number to delay the start of the block time "Ice Age". Furthermore, Uncle rewards will be adjusted and Nephew rewards will be removed to eliminate excess ancillary ETH issuance. The current ETH block reward of 3 ETH will remain constant.
...
The Difficulty Bomb has been delayed, but not removed, to ensure block times remain consistent until the hard fork planned for end of 2019.
