---
eip: 4786
title: Compose Common Token With ERC-721
description: Compose ERC721 token with ERC721/ERC1155/ERC20 token
author: Poria Cattus (@poria-cat)
discussions-to: https://github.com/ethereum/EIPs/issues/4786
status: Draft
...
```
/**
 * @title ERC-4786: Compose Common Token With ERC-721
...
[Poria Cattus](https://github.com/poria-cat), "EIP-4786: Compose Common Token With ERC-721," *Ethereum Improvement Proposals*, no. 4786, June 2018. [Online serial]. Available: https://eips.ethereum.org/EIPS/eip-4786.
