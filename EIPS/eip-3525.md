...
description: An ERC-721 compatible standard that a token can have a value and a slot, the value of two tokens are fungible when they have same slot.
...
Each ERC-3525 token, like an ERC-721 token, contains an ID property to identify itself as a universally unique entity, so that the tokens can be transferred between addresses and approved to be operated in ERC-721 compatible way.
...
```json
{
  ...
  "properties": {
    ...
    "properties": {
      "type": "array",
      "description": "Arbitrary properties. Each property SHOULD be organized in object format, containing name, value, description (optional), display_order (optional), etc."
      "items": {
        "type": "object",
        "properties": {
          "name": {
          ...
          "description": {
            "type": "string",
            "description": "Optional. Describes this property."
          }
          "value": {
            "description": "The value of this property, which may be a string or a number."
          },
          "display_order": {
            "type": "integer",
            "description": "Optional. Specifies in what order the properties should be displayed."
          },
	  "display_type": {
            "type": "string",
            "description": "Optional. Specifies in what form this property should be displayed."
...
As mentioned in the beginning, this EIP is an compatible standard of ERC-721.
