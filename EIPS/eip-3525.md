...
pragma solidity ^0.7.6;
interface ERC3525Metadat /* is IERC721Metadata */ {
    function contractURI() external view returns (string memory _contractURI);
}
```
