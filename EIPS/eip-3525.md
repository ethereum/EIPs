...
This is a standard for semi-fungible tokens. The set of smart contract interfaces described in this document defines an ERC-721 extension, by introducing an 'ID-SLOT-UNITS' triple scalar, where ID is the tokenId of ERC-721, and 'units' property to represent the quantitative nature of a token and enabling some quantitative operations for the token, most notably splitting and merging.
...
This is the "ERC-3525 Metadata JSON Schema" referenced above.
