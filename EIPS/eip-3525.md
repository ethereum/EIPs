...
interface ERC3525 /* is ERC721 */{
     ...
     */
    function split(uint256 _tokenId, uint256[] calldata _values) external payable returns (uint256[] memory) ;

    function splitTo(uint256 _fromTokenId, address[] calldata _to, uint256[] calldata _values) external payable returns (uint256[] memory);
     ...
     */
    function merge(uint256[] calldata _fromTokenIds, uint256 _toTokenId) external payable;
     ...
     * @return The token created after transfer containing the transferred units
     */
    function safeTransferValueFrom(uint256 _fromTokenId, address _to,  uint256 _value, bytes calldata _data) external payable returns (uint256);
}
```
...
pragma solidity ^0.7.6;
//TODO: Smart Contract Visualization
interface ERC3525Metadata /* is ERC721Metadata */ {
