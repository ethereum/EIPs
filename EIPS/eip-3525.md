...
The value level approval and slot level approval(optional) is isolated from ERC-721 approval models, so that in will not cause secutiry problems to ERC-721 level approvals, implementations of this EIP must obey this principal.
