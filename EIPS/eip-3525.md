...
interface ERC3525 /* is ERC-721 */{
    ...
    function splitTo(uint256 _fromTokenId, address[] calldata _to, uint256[] calldata _units) external returns (uint256[] memory);
     ...
     */
    function transferUnitsFrom(uint256 _fromTokenId, uint256 _toTokenId, uint256 _units) external;
     ...
     */
    function transferUnitsFrom(uint256 _fromTokenId, address _to, uint256 _units) external returns (uint256);
     ...
     * @return The token created after transfer containing the transferred units
     */
    function safeTransferUnitsFrom(uint256 _fromTokenId, address _to,  uint256 _units, bytes calldata _data) external returns (uint256);
}
```
