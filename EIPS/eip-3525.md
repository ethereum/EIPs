...
ERC-3525 introduces new token transfer models than ERC-721, including value transfer between two tokens of then same slot, as well as value transfer from a token to an address.
