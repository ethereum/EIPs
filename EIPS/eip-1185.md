...
The arguments for the function are as follows:
  ...
  - resource: the resource record ID.  Resource record IDs are defined in [RFC1035](https://tools.ietf.org/html/rfc1035) and subsequent RFCs.
...
This function is needed by DNS resolvers when working with wildcard resources as defined in [RFC4592](https://tools.ietf.org/html/rfc4592).
