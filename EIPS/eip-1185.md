...
The resolver profile to support DNS on ENS follows the resolver specification as defined in [EIP-137](./eip-137.md).
...
The arguments for the function are as follows:
  ...
  - node: the namehash of the fully-qualified domain in ENS for which to set the records.  Namehashes are defined in [EIP-137](./eip-137.md)
...
The arguments for the function is as follows:
  ...
  - node: the namehash of the fully-qualified domain in ENS for which to clear the records.  Namehashes are defined in [EIP-137](./eip-137.md)
