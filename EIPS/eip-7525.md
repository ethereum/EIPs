...
author: Dan Park (@coldpak) <dan@over.network>, Ben Kim <ben@over.network>, Jade Shin <jade@over.network>, et al.
...
According to our analysis[^1], we have observed that 95% of the accounts in Execution Layer have been inactive for at least one month. The inactive accounts refer to those that have not been in engaged or affected by any transactions.
...
[^1]:
    ```csl-json
  {
    ...
    "URL": "https://dl.acm.org/doi/pdf/10.1145/3447786.3456231"
  }
    ```
