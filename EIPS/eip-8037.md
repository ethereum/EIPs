...
Inclusion of a transaction in a block requires that the cumulative regular gas used of all previous transactions added to the transaction gas limit not exceed the block gas limit.
