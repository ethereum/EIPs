...
The `EXECUTE` precompile allows rollups to define their own inputs and constrain their behaviour through smart contract. For example, in contrast to Ethereum's own consensus layer, a rollup can decide to:
...
This allows projects to preserve most of their configurations they already benefit from.
