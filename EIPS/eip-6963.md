...
The wallet provider MUST announce their own [EIP-1193](./eip-1193.md) provider interface and `EIP6963ProviderInfo` defined above in the following interface `EIP6963ProviderDetail`:
