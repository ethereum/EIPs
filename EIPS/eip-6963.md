...
A Javascript communication protocol that enables multiple wallet providers to be discovered from an EVM-based application using a browser extension injected script through window events.
