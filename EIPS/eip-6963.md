...
The wallet provider will also announce their own [EIP-1193](./eip-1193.md) provider interface in parallel with the provider info provided above in the following interface `EIP6963ProviderDetail`
