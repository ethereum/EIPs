...
1. Choosing [EIP-5269] instead of [EIP-165](./eip-165.md) because the data format cannot be represented by method siganture as in [EIP-165](./eip-165.md).
...
### Replay-attack
Replay attack is a type of attack on cryptography authentication.
...
### Phishing
It's worth pick out a special form of replay-attack by phishing.
