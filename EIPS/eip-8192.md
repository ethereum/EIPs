...
description: An innovative extension to the ERC-721 token that introduces dynamic ownership and nesting capabilities.
...
ERC-721D is fully backwards compatible with the ERC-721 standard. It extends the ERC-721 standard by adding dynamic ownership while maintaining all existing functionalities. Any existing ERC-721 token can be upgraded to an ERC-721D token while retaining its original capabilities.
...
For a reference implementation, please see [here](https://github.com/hiddenintheworld/ERC-8192). This repository contains the Solidity code for the ERC-721D contract, including the necessary functions for minting tokens, setting and changing the ownership, and burning tokens.
