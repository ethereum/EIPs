...
This EIP proposes a new token interface which is compatible with [EIP-721](./eip-721.md) and [EIP-3525](./eip-3525.md).

This EIP is also compatible with [EIP-165](./eip-165.md).
