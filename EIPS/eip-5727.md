...
### Extensions
All extensions below are OPTIONAL for EIP-5727 implementations. An implementation MAY choose to implement some, none, or all of them.
#### Enumerable
...
## Rationale
### Token storage model
We adopt semi-fungible token storage models designed to support both fungible and non-fungible tokens, inspired by EIP-3525. We found that such a model is better suited to the representation of SBT than the model used in [EIP-1155](./eip-1155.md).
