...
$$K_O = PK_A * SK_{O_{-}A} = \left(SK_A * P \right) * SK_{O_{-}A} = SK_A * \left(SK_{O_{-}A} * P \right)= SK_A * PK_{O_{-}A} = K_A$$
...
$$K_U = PK_A * SK_{U_{-}A} = \left(SK_A * P \right) * SK_{U_{-}A} = SK_A * \left(SK_{U_{-}A} * P \right)= SK_A * PK_{U_{-}A} = K_A$$
