...
description: A standard interface of smart non-fungible tokens representing smart assets that can generate their own blockchain accounts and obey users.
