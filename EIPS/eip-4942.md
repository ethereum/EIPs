...
Related work exists in other systems that support stateless or near stateless validation through explicit state proofs or execution witnesses. This specification differs by integrating witness handling directly into the block execution model while preserving Ethereum’s existing execution semantics and client architecture.
