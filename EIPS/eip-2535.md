...
EIP-2535 is an improved design over [EIP-1538](./eip-1538.md) using `ABIEncoderV2` and function selectors. EIP-2535 supersedes EIP-1538.
...
Developer tools can use the loupe functions to enumerate the functions a `Diamond` has implemented and the corresponding `Facet`s.
