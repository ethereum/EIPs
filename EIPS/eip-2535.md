...
The `diamondCut` function reverts when attempting to add a function that already exist.

The `diamondCut` function reverts when attempting to replace a function with a facet it is already using.

The `diamondCut` function reverts when attempting to remove a function that already doesn't exist.
