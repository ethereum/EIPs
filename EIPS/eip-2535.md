...
A `Diamond` MUST have four standard functions called the loop functions that are used to show what functions that `Diamond` implements.

The following list provides example use-cases for these loop functions:
