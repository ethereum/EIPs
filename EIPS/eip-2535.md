...
1. A single address for unlimited contract functionality. Using a single address for contract functionality makes deployment, testing and integration with other smart contracts and user interfaces easier.
...
## Organizing Storage Layout in Diamonds
...
Mentioned below are diamond storage and AppStorage which are two state variable organizational patterns that have been successfully used in diamonds. 
