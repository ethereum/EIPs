...
discussions-to: https://ethereum-magicians.org/t/eip-7776-prevent-block-gas-smuggling/21234
status: Draft
...
Prevent the circumvention of the block gas limit by excluding certain gas discounts and refunds from block gas accounting, except for those reflecting actual reductions in computational work. This proposal aims to align the block gas usage with the Ethereum Virtual Machine's (EVM) real workload, preventing "block gas smuggling." It complements [EIP-7623](./eip-7623) by further reducing the maximum block size and its variance, enhancing network stability and efficiency.
