...
**Figure 2.** Proposed restriction imposed on the blob base fee to ensure desirable equilibrium formation. When the blob fee is the primary price signal (green area), equilibrium can form just as today. When the execution fee is the primary price signal (red area), the demand curve becomes too inelastic, and the blob base fee is imposed to rise to the green area, at a pace determined by how many blobs actually gets posted. Black lines indicate fee parity between blob data cost and execution costs.
