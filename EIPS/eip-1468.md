...
This function should retrieve information about the debt and try to fulfil the transfer of payments in order to fulfill the debt. It must accomodate the fulfimment by calling the transferFrom method of a ERC20 token or if msg.value is positive, fulfill the payment with Ether.  
