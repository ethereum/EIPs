...
The limits of 64 transaction hashes and 64 masks are introduced by this EIP for indexed messages. They are not inherited from EIP-8070 and do not change the limits or semantics of the shared forms. A mask identifier remains one byte, allowing a future protocol version to raise the mask-table limit to at most 256 without changing the identifier encoding.
