...
The reference implementation is available [here](../assets/eip-4361/Notes.md). 

## Test Cases
The [reference implementation](../assets/eip-4361/Notes.md) contains a suite of tests stored in JSON files.
