...
Over the years native subroutine operations have proven optimal for efficient implementation and simple code.
...
* _Jump to the address popped off of the `data stack`._
