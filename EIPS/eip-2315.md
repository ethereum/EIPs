...
If the execution of an instruction would violate a condition, then the execution is in an exceptional halting state. The [Yellow Paper](../../yellowpaper) defines five such states.
1. Insufficient gas
