...
We have chosen Turing's simple design, as have Forth, the JVM, Wasm and many other stack machines. We keep return addresses on a dedicated FIFO`return stack`.  The instruction to call a subroutine will
...
We prefer Turing's design for three main reasons.
