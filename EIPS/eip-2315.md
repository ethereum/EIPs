...
Subroutines were first proposed by Alan Turing ([1945](http://www.alanturing.net/turing_archive/archive/p/p01/p01.php)) as a means of structuring code for his [Automatic Computing Engine](https://doi.org/10.1093/comjnl/20.3.269):
