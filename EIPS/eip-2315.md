...
Taken together with other required propoposals they provide an _efficient, static, and safe_ control-flow facility.
...
Similar designs are used by the register machines we have programmed, where registers rather than the stack are used for computation, and subroutine calls use the stack for return addresses and arguments. We give an example of the alternative design above. 
