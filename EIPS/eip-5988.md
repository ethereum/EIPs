...
Those tests are available [here](../assets/eip-5988/papers/test/poseidon/test_vectors.txt).
...
We can see the same rationale for the KZG ceremony in the [EIP-4844](./eip-4844), arguing that the risk of a vulnerability in the KZG ceremony is limited to the rollups that use it.
