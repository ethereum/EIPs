...
Deploy it with the default `Extendable` constructor `constructor(address extendLogic)` by passing it the address of the `ExtendLogic` extension contract.
...
Extendable contracts are given access to the introspection functions of Extensions through the `ExtendLogic` extension.
