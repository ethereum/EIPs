...
description: This EIP adds a new transaction type that includes expiration with a blocknum
...
## Abstract
This EIP adds a new transaction type that includes expiration with a blocknum.
