...
interface IERC6366Core {
  ...
  function hasSufficientPermission(address _user, address _owner, uint256 _required) external pure returns (bool hasPermission);
...
Returns `true` if `_required` permission is a subset of `_user`'s permissions or a subset of his delegated permissions granted by the `_owner`.
...
- [ERC-6366 Core implementation](https://github.com/orochi-network/EIP-6366/blob/main/contracts/ERC6366/ERC6366Core.sol)
- [ERC-6366 Meta implementation](https://github.com/orochi-network/EIP-6366/blob/main/contracts/ERC6366/ERC6366Meta.sol)
