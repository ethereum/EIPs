...
author: Joel Thorstensson (@oed), Oliver Terbu (@awoie)
...
* `recipients` - a json array of strings. Every entry refers to a public key of one recipient of the JWE. Each public key MUST be encoded as base58 multibase.
