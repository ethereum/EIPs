...
Owned Accounts (EOAs) to set the code in their account. This is achieved by
adding a a list of `[chain_id, address, nonce, y_parity, r, s]` authorization
...
A new [EIP-2718](./eip-2718.md) transaction know as the "set code transaction"
...
nonce, for each `[chain_id, address, nonce, y_parity, r, s]` tuple perform the
following:
