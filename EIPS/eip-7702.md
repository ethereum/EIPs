...
The impact-based assessment leaves us with `1216` gas for the operation. We round up to `12500` to account for miscellaneous costs associated with shuttling data around the state transition.
