...
If any of the above steps fail, immediately stop processing that tuple and continue to the next tuple in the list. In the case of multiple tuples for the same authority, set the code specified by the address in the last occurrence.
