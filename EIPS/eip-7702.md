...
In order to simplify the migration of an account from one delegate contract to another, it is important for delegate contracts to use storage in a disciplined way that ensures they won't conflict with one another. For example, through the use of [EIP-7201](./eip-7201.md) 
