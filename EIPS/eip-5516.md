...
The purpose of this document is to create a Double-Signature SBT standard by creating consensus around a maximally [EIP-1555](./eip-1555.md) compatible interface definition. 

### Characteristics
* The NFT will be non-transferable after the initial transfer(Soulbound/Accountbound Token-SBT).
* Backwards compatible with [EIP-1555](./eip-1555.md).
* Double Signature.
* Multi-Token.
* Multi-Owned.
* Semi-Fungible.
...
### Applications
* [EIP-1555](./eip-1555.md) Soulbound NFTs.
* Academy.
* Certifications.
...
**Given the multi owner characteristic of [EIP-1555](./eip-1555.md) compliant interfaces and contracts, this allows for SBTs to bind to multiple accounts, providing for a potential solution to the issue.**  
