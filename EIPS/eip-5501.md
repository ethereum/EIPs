...
**Every EIP-5501 compliant contract MUST implement the IERC-5501 interface. This extension is OPTIONAL for [EIP-721](./eip-721.md) contracts.**
```solidity
/**
...
**The Balance extension is OPTIONAL for EIP-5501 smart contracts. This gives the options to query amount of tokens user has.**
```solidity
/**
...
**The Enumerable extension is OPTIONAL for EIP-5501 smart contracts. This allows to iterate over user balance.**
```solidity
/**
...
**The Terminable extension is OPTIONAL for EIP-5501 smart contracts. This allows to terminate the rent early if both parties agree.**
```solidity
/**
