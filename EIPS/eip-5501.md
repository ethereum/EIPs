...
**The Balance extension is OPTIONAL. This gives the options to query amount of tokens user has.**
```solidity
/**
...
**The Terminable extension is OPTIONAL. This allows to terminate the rent early if both parties agree.**
```solidity
/**
