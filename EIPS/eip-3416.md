...
(TO BE REVIEWED) The rationale for the `BLOCK_GAS_TARGET` to be `1 // 1024` is that miner need some adaptativity to high volumen intraday times (maximum change in 4 hours is 100%), but we do not want something to instable by the minute.
