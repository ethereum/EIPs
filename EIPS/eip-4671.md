...
contract EIPCreatorNon-tradable token is ERC4671 {
    constructor() ERC4671("EIP Creator Non-tradable token", "EIP") {}

    function giveThatManANon-tradable token(address owner) external {
