...
An interface allowing a token owner to transfer his token to another of his wallets.The caller must provide a signature of the tuple (tokenId, recipient).
