...
/**
 * @dev Implementation of ERC7114
 */
contract ERC7114 is IERC7114, ERC20 {
    ...
    */
    ...
    function transferValidation(uint256 transferId) public view override returns (TransferValidation memory) {
        require(transferId < _totalTransferValidations, "ERC7114: invalid transfer ID");
    ...
    function approvalValidation(uint256 approvalId) public view override returns (ApprovalValidation memory) {
        require(approvalId < _totalApprovalValidations, "ERC7114: invalid approval ID");
    ...
    function _validateApproval(uint256 approvalId) internal virtual {
        ...
        require(!v.valid, "ERC7114: the approval is already validated");
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC7114: transfer from the zero address");
        require(to != address(0), "ERC7114: transfer to the zero address");
    ...
    function _approve(
        ...
        require(owner != address(0), "ERC7114: approve from the zero address");
        require(spender != address(0), "ERC7114: approve to the zero address");
