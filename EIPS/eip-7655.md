...
discussions-to: https://ethereum-magicians.org/t/eip-7655-nft-bound-modularized-contract/15694
status: Draft
...
- **Streamline Operation while Ensuring Security**
  ...
  ![](../assets/eip-7655/streamline_operation.png)
...
- **Overview**
  ...
  ![](../assets/eip-7655/architecture.png)
...
- **Application**
  ...
  - **SmartNFT for Customizable Interactions**
    ...
    ![](../assets/eip-7655/interoperation.png)
  ...
  - **Advanced Usage - Combination SmartNFT**
    ...
    ![](../assets/eip-7655/combination_nft.png)
    ...
    ![](../assets/eip-7655/proxy_hold_nft.png)
