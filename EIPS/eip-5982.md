...
1. Compliant contract MUST implement `IERC_ACL_CORE`
2. Compliant contract SHOULD implement `IERC_ACL_GENERAL`
3. Compliant contract MAY implement the `IERC_ACL_METADATA`.
