...
Test vector for all operations are expanded in this `csv` files in (github.com/matter-labs/eip1962/tree/master/src/test/test_vectors/eip2537).
...
There is a various choice of existing implementations of the curve operations. It may require extra work to add an ABI:
	- EIP1962 code bases with fixed parameters
	  - Rust: github.com/matter-labs/eip1962
	  - C++: github.com/matter-labs/eip1962_cpp
