...
### Required functionas for Interoperability
...
The following functions are REQUIRED to enable the management of bond tokens from the same issuance across multiple blockchain networks.
