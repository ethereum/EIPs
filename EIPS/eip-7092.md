...
interface IERC7092 {
    ...
    *         NOTICE: The `issue volume` in denomination unit MUST be equal to the `totalSupply` of the bonds, i.e. the total number of bond tokens issued.
    */
    ...
    *         NOTICE: The `principal` in denomination unit MUST be equal to the `balance` of an account, i.e. the number of bond tokens owned by an account.
...
like ERC-20 or ERC-1155. The ERC-7092 is a representation of a new token for bonds with all bonds chracateristics
