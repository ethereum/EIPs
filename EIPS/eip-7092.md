...
**Every contract compliant with the [ERC-7092](./eip-7092) MUST implement the following interface**
...
The reference implementation of [ERC-7092](./eip-7092) can be found [here](../assets/eip-7092/ERC7092.sol).
