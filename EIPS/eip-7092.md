...
used in other standards like [ERC-20](./eip-721) and [ERC-1155](./eip-1155) is not
...
like [ERC-20](./eip-20) or [ERC-1155](./eip-1155), the ERC-7092 is a representation of a new token for bonds with all bonds chracateristics
and functionalities already attached to it.

*__For the reasons mentionned above, we recommand a pure implementation of the standard__* to issue tokenized bonds, since any hybrid solution
with other standard mentionned above will fail.
