...
discussions-to: [777](https://github.com/ethereum/EIPs/issues/777)
status: Draft
type: ERC
category: ERC
created: 2017-11-20
...
| **Image** | &nbsp;![beige logo](eip-777/logo/png/ERC-777-logo-beige-48px.png) | &nbsp;![white logo](eip-777/logo/png/ERC-777-logo-white-48px.png) | &nbsp;![light grey logo](eip-777/logo/png/ERC-777-logo-light_grey-48px.png) | &nbsp;![dark grey logo](eip-777/logo/png/ERC-777-logo-dark_grey-48px.png) | &nbsp;![black logo](eip-777/logo/png/ERC-777-logo-black-48px.png?raw=true)
|----------:|:---------:|:---------:|:------------:|:-----------:|:---------:|
...
The logo for the standard can be found in the [eip-777/logo](eip-777/logo) folder in [svg](eip-777/logo/svg) and [png](eip-777/logo/png) formats. The `png` version of the logo offers a few sizes in pixel. If needed, other sizes CAN be created by converting from `svg` into `png`.
