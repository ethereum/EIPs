...
the reduction by [EIP-2929](./eip-2929) made it slightly more economical.
...
This ordering matches the other copying instructions, i.e. `CALLDATACOPY`, `RETURNDATCOPY`.
