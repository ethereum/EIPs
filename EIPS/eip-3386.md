...
author: Calvin Koder <ashrowz@mailbox.org>
...
interface IWrapper /* is ERC165 */ {
     ...
     * The `_id` argument MUST be the id of the {Base} token transfered.
     * The `_amount` argument MUST be the number of {Base} tokens transfered.
     ...
     * The `_to` argument MUST be the address of the account that received the {Derivative} token(s).
     * The `_ids` argument MUST be the list ids of the {Base} tokens transfered.
     * The `_amounts` argument MUST be the list of the numbers of {Base} tokens transfered.
     * The `_value` argument MUST be the number of {Derivative} tokens minted.
     */
     ...
     * The `_ids` argument MUST be the list of ids of the {Base} tokens transfered.
     * The `_amounts` argument MUST be the list of the numbers of {Base} tokens transfered.
     * The `_value` argument MUST be the number of {Derivative} tokens burned.
     */
    ...
    /**
     * @notice Transfers the {Base} token with `_id` from `_from` to the {Pool} and mints {Derivative} token(s) to `_to`.
    ...
    /**
     * @notice Transfers `_amounts[i]` of the {Base} tokens with `_ids[i]` from `_from` to the {Pool} and mints {Derivative} token(s) to `_to`.
     * @param _from     Source address.
     * @param _to       Target address.
     ...
     * @param _to       Target address.
     * @param _ids      Ids of the {Base} tokens.
     * @param _amount   Amounts of the {Base} tokens.
     *
     * Emits either a {BurnSingle} or {BurnBatch} event.
     */
...
- `mint`/`redeem` (NFTX)
- `deposit`/`withdraw` (WrappedKitties)
- `wrap`/`unwrap` (MoonCatsWrapped)
...
If not inherting from {ERC721Receiver} and/or {ERC1155Receiver}, the pool MUST be limited such that the base tokens can only be transferred via the Wrapper's `mint`, `burn`.
...
With the functions `idBurn`, `idBurns`, users may target the most valuable NFT within the generic lot.  If there is a significant differnce between tokens values of different ids, the contract SHOULD consider creating specialized pools (NFTX) or pricing (NFT20) to account for this.
...
- [ERC-1155 Multi-Token Token Standard](./eip-1155.md)
- [RFC 2119 Key words for use in RFCs to Indicate Requirement Levels](https://www.ietf.org/rfc/rfc2119.txt)

**NFTWrapper Implementations and Other Projects**

- [Wrapped CryptoKitties](https://wrappedkitties.com/)
    - [Lite Paper](https://www.wrappered.com/litepapurr.html)
    - [Contract](https://etherscan.io/address/0x09fE5f0236F0Ea5D930197DCE254d77B04128075)
    - WG0 (Wrapped Gen 0 Kitties)
- [NFTX](https://nftx.org)
    - [Lite Paper](https://docs.nftx.org/)
    - [X Token](https://etherscan.io/address/0x69BbE2FA02b4D90A944fF328663667DC32786385)
    - [MASK X](https://etherscan.io/address/0x0fe629d1E84E171f8fF0C1Ded2Cc2221Caa48a3f)
- [NFT20](https://nft20.io)
    - [Lite Paper](https://docs.nft20.io/lite-paper/)
    - [MEME20](https://etherscan.io/address/0x60acd58d00b2bcc9a8924fdaa54a2f7c0793b3b2)
- [B.20](https://b20.metapurse.fund/)
    - [Contract](https://etherscan.io/address/0xc4De189Abf94c57f396bD4c52ab13b954FebEfD8)
- [MoonCatsWrapped](https://etherscan.io/address/0x7c40c393dc0f283f318791d746d894ddd3693572)

- [NFTFI](https://nftfi.org)

**Articles & Discussions**
---

- [https://dappradar.com/blog/nftx-the-first-nft-index-fund-has-arrived](https://dappradar.com/blog/nftx-the-first-nft-index-fund-has-arrived)

- [https://forum.nftx.org/t/d1-fund-mint-redeem-mechanism-discussion/176](https://forum.nftx.org/t/d1-fund-mint-redeem-mechanism-discussion/176)


**Issues**

- Original proposal: [https://github.com/ethereum/EIPs/issues/3349](https://github.com/ethereum/EIPs/issues/3349)
- [https://github.com/ethereum/EIPs/issues/3375](https://github.com/ethereum/EIPs/issues/3375)
