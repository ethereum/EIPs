...
### Optional ERC-6105 collection offer extention
...
### Optional ERC-6105 item offer extention
...
There is a potential re-entrancy risk with the `acceptCollectionOffer` and `acceptItemOffer` functions. Make sure to obey the checks, effects, interactions pattern or use reentrancy guard.
