...
- `CODESIZE` and `CODECOPY` are rejected by validation in EOF contracts, with no replacements fully functional replacents.  A separeate EIP addresses opcodes for embedded data.
