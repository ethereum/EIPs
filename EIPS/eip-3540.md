...
In case *initcode* is invalid, gas for its execution is not deducted and the nonce of the current account is not increased. In case *code* is invalid, all creation gas is deducted and the nonce of the current account is increased, similar to exceptional abort during *initcode* execution.
