...
To summarise, EOF bytecode has the following format:
```
...
2. Execution starts at the first byte of the *code*, and `PC` is set to this position within the *container* (e.g. `PC=10` for a *container* with a code and data section).
