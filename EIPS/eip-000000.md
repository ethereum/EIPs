...
![Fig2]("../assets/eip-000000/visual-Highlight-Path-Red-evm-based-aliasing..png")
...
Lastly, it is recommended that as part of the `relativeAddress` validation the target system performs an address checksum validation as defined in [[EIP-55](#eip-55)].
...
<a name="eip-55"> **[EIP-55]** </a>
Vitalik Buterin , Alex Van de Sande, "Mixed-case checksum address encoding", EIP-55, EIP Repository, January 2016
