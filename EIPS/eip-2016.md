...
author: Erik Mars (@rekmarks), Pedro Gomes (@pedrouid)
...
All URL string fields **SHOULD** include the protocol component of the URL.
If the protocol of the URL is HTTP, HTTPS **SHOULD** be used, and the `https://` prefix **SHOULD** be included.
