...
interface IERC5827 /* is ERC20, ERC165 */ {
    ...
    * SHOULD throw InsufficientRenewableAllowance when there is insufficient allowance
...
`approveRenewable(address _spender, uint256 _value, uint256 _recoveryRate)` MUST set both the initial allowance amount and the maximum allowance limit to which it can recover to `value`.
