...
repository [here](https://github.com/Daniel-K-Ivanov/erc-721-consumer-extension/blob/main/test/erc721-consumable.ts#L6)
...
Other implementations of the `Consumable` role:
- [LandWorks](https://github.com/EnterDAO/LandWorks-protocol/blob/main/contracts/facets/ERC721Facet.sol) (Metaverse 
  land renting marketplace) - Issues `ERC721Consumable` NFTs for deposited land. The NFTs can 
  be staked into [yield-farming](https://github.com/EnterDAO/LandWorks-YF-Contracts/blob/main/contracts/LandWorksDecentralandStaking.sol) contracts **and** allow for the staker to still manage/collect rent from the protocol.
- Universe (NFT minting marketplace) - Issues `ERC721Consumable` NFTs by default for the minted collections. (TODO 
  Link)  
