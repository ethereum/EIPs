...
When applied to wrapped ERC20 token trading, this value-amplification system revolutionizes the asset transaction industry by incorporating identities into the time and sales (T&S) data. This inclusive feature provides a comprehensive view of each transaction, adding a new dimension to trading.
...
[This folder](../assets/eip-5173/Implementation) contains the reference implementation for EIP-5173.
