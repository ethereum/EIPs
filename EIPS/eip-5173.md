...
The code for the reference implementationis is [here](../assets/eip-5173/Implementation).
...
```
The complete implementation code can be found [here](../assets/eip-5173/Implementation).
