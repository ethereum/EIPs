...
author: Lanyin Zhang(lz8aj@virginia.edu), Jerry(jerrymindflow@gmail.com), Amandafanny(amandafanny200@gmail.com) 
...
For each wrap process, a unique ID should be generated. This ID is essential for verification during the unwrap process. It also serves as the exclusive credential for the token. This mechanism ensures the security of assets within the Agency. While it's suggested, it's not mandatory to use the ERC-721 standard.
