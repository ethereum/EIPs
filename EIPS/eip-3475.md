...
**This demonstration shows only basic  ERC-3475  Bonds example implementation. Developers can build much sophisticated logic (zero coupon bond) with this interface**
