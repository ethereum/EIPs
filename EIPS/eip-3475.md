...
[Reference Interface](../assets/eip-3075/IERC3475.sol) :**This demonstration shows only basic bonds reference implementation. Developers can build much-sophisticated logic (like fixed/floating rate bonds) with this interface, and the Debond-ERC3475 gives a reference example**


[real usecase implementation](https://github.com/Debond-Protocol/Debond-ERC3475/blob/main/contracts/DebondERC3475.sol).
