...
description: Set of RPC methods that an Ethereum node should implement.
...
**Note:** See [EIP-155](./eip-155.md) for a list of possible chain IDs.
...
**Note:** Client developers should refer to [EIP-712](./eip-712.md) for complete semantics around encoding and signing data. Dapp developers should refer to [EIP-712](./eip-712.md) for the expected structure of RPC method input parameters.
