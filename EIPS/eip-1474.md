...
**Note:** See EIP-155 for a [list](./eip-155.md) of possible chain IDs.
...
**Note:** Client developers should refer to EIP-712 for complete semantics around [encoding and signing data](./eip-712.md). Dapp developers should refer to EIP-712 for the expected structure of [RPC method input parameters](./eip-712.md).
