...
discussions-to: https://ethereum-magicians.org/t/eip-6601-evm-modular-arithmetic-extensions-evmmax
category: Core
created: 2023-03-02
requires: 4750, 3670
---
...
r_squared       <mod_size bytes> - Montgomery parameter used by STOREX to convert values to Montgomery form (omitted if setup section is dynamic)
```
...
if mod_id in evmmax_state.mods:
    # the modulus state keyed by mod_id was already active in this call-frame.  nothing to do.
    return 
