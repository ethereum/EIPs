...
To create and deploy this ERC contract one **MAY** only inherit directly from this [ERC-721](./eip-721.md) extension that would directly signal support for this ERC:
