...
interface ERC1155TokenReceiver {
    /**
        ...
        Return of other value than the magic value MUST result in the transaction being reverted.
    ...
    */
    ...
    /**
        ...
        This function MAY throw to revert and reject the transfer.
        Return of other value than the magic value WILL result in the transaction being reverted.
        Note: The token contract address is always the message sender.
