...
Changes to the URI or Name SHOULD emit their corresponding events. If the optional ERC1155Metadata_URI or ERC1155Metadata_Name extensions are included, the values returned by these functions MUST take precedence over the latest event values.
