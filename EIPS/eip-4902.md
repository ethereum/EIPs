...
As humans, we are constantly seeking as much access to resources as possible. We also regularly make access trades for our needs, which can include information, food, rides, content, hotels, jobs, and so on. The trade could be as simple as one person seeking access to food and the other seeking access to money.
