...
The full specification of the proposed change can be found in [`/specs/_features/eip7549/beacon-chain.md`](https://github.com/ethereum/consensus-specs/blob/59d1f1359ccf2b723d53c2e0e7a0ecf947e2a708/specs/_features/eip7549/beacon-chain.md).
...
3. Changing the field type to Optional (from [EIP-7495](https://eips.ethereum.org/EIPS/eip-7495) StableContainer)
