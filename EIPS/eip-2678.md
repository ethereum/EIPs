...
<a name="package-specification"></a>
...
| Required | No |
| Key | `meta` |
| Type | [Package Meta Object](#package-meta-object) |
...
| Required | No |
| Key | `sources` |
| Type | Object (String: [Sources Object](#source-object)) |

<a name="contract-types"></a>
...
| Required | No |
| Key | `contractTypes` |
| Type | Object (String: [Contract Type Object](#contract-type-object)) |
| Format | Keys **must** be valid [Contract Aliases](#term-contract-alias). <br> Values **must** conform to the [Contract Type Object](#contract-type-object) definition. |
...
| Required | No |
| Key | `compilers` |
| Type | Array ([Compiler Information Object](#compiler-information-object)) |
...
| Required | No |
| Key | `deployments` |
| Type | Object (String: Object(String: [Contract Instance Object](#contract-instance-object))) |
| Format | Keys **must** be a valid BIP122 URI chain definition. <br>Values **must** be objects which conform to the following format:<br>- Keys **must** be valid [Contract Instance Names](#term-contract-instance-name)<br>- Values **must** be a valid [Contract Instance Object](#contract-instance-object) |
...
| Format | Keys **must** be valid [package names](#name).<br>Values **must** be a [Content Addressable URI](#term-content-addressable-uri) which resolves to a valid package that conforms the same EthPM manifest version as its parent. |

<a name="object-definitions"></a>
...
<a name="link-reference-object"></a>
...
| Required | No |
| Type | String |
| Format | **must** conform to the [Identifier](#term-identifier) format. |

<a name="link-value-object"></a>
...
| Required | Yes |
| Type | String |
| Allowed Values | `"literal"` for bytecode literals.<br>`"reference"` for named references to a particular [Contract Instance](#term-contract-instance) |
...
| Required | No |
| Type | Array |
| Format | All values **must** be valid [Link Reference objects](#link-reference-object). See also below. |
...
| Required | No |
| Type | Array |
| Format | All values **must** be valid [Link Value objects](#link-value-object). See also below. |
...
| Value | [Source Object](#source-object) |

<a name="source-object"></a>
...
| Key | `checksum` |
| Value | [Checksum Object](#checksum-object) |
...
| --- | --- |
| Required | If the [Contract Name](#term-contract-name) and [Contract Alias](#term-contract-alias) are not the same. |
| Type | String |
| Format | **Must** be a valid [Contract Name](#term-contract-name) |
...
| Required | No |
| Type | String |
| Format | **Must** match a unique source ID included in the [Sources Object](#sources-object) for this package. |
...
| Required | No |
| Type | Object |
| Format | **Must** conform to the [Bytecode object](#bytecode-object) format. |
...
<a name="contract-instance-object"></a>
...
<a name="compiler-information-object"></a>
...
| Required | No |
| Key | `contractTypes` |
| Type | Array([Contract Alias](#term-contract-alias)) |
...
| Linked Bytecode | The hexadecimal representation of a contract’s EVM instructions which has had all [Link References](#term-link-reference") replaced with the desired [Link Values]("#term-link-value"). **Example**: `0x606060405260e06000736fe36000604051602001526040518160e060020a634d536f` |

<a name="term-chain-definition"></a>
Chain Definition  
...
<a name="term-content-addressable-uri"></a>
...
<a name="term-contract-instance"></a>
Contract Instance  
...
<a name="term-contract-instance-name"></a>
...
<a name="term-package-manifest"></a>
Package Manifest  
A machine-readable description of a package.

<a name="term-prefixed"></a>
Prefixed  
