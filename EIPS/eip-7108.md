...
### ERC7108Enumerable extension 

It is convenient to have a function to retrieve the balance of a wallet within a specific cluster. However, a standard [ERC-721](./eip-721.md) may not be able to return that value, because the implementation may require that the NFT is enumerable. For this reason, the following function is set in a separate interface, which should be implemented with [ERC-7108](./eip-7108.md) to retrieve the balance of a wallet within a specific cluster.
