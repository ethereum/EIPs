...
By separating the canonical version of the work from its various licensed uses (NFT purchase, streaming, usage of art etc..) this EIP introduces a new ecosystem of various license types and payment types for a single work, based on the same standard.
