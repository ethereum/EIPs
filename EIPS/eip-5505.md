...
description: Extends [EIP-1155](./eip-1155.md)  to support crucial operations for asset backed NFTs.
...
## Abstract
To propose an extension of smart contract interfaces for asset-backed, fractionalized projects using [EIP-1155](./eip-1155.md)) standard such that total acquisition will become possible. This proposal focuses on In-Real-Life asset, where total acquisition should be able to happen.
...
## Rationale
Native ETH is supported by via WETH [EIP-20](./eip-20.md).
