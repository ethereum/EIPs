...
```json
{
    ...
    "properties": {
        ...
        "properties": {
             "type": "object",
             "description": "Defines a set of properties which classifies and defined the NFT. Allows for applications to easily build fitler and property search functionalities for a set of NFTs.",
             "required": false
        }
    }
}
