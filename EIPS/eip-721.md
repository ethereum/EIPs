...
0xcert `ERC721` Token includes test cases written using Truffle.
...
1. [`transferAndCall` Token Standard](https://github.com/ethereum/EIPs/issues/677).
1. [Token Standard](https://github.com/ethereum/EIPs/issues/827).
...
1. [0xcert `ERC721` Token](https://github.com/0xcert/ethereum-erc721).
