...
interface ERC721 {
    ...
    ///  set for the first time, reaffirmed by setting the same value, or by setting to  
    ///  to a new value. The "approved taker" is the zero address if nobody can take the
