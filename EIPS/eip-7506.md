...
```solidity
function setHintSigned(address namespace, bytes32 _list, bytes32 _key, bytes32 _value, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setHintsSigned(address namespace, bytes32 _list, bytes32 _key, bytes32[] calldata _values, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setHintDelegatedSigned(address namespace, bytes32 calldata _entry, bool _isTrusted, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setHintsDelegatedSigned(address namespace, bytes32 _list, bytes32 _key, bytes32[] calldata _values, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setListStatusSigned(bytes32 _list, bytes32 _key, bool _revoked, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setListOwnerSigned(bytes32 _list, bytes32 _key, address _newOwner, address _signer, bytes calldata _signature) public;
```
