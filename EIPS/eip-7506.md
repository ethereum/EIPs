...
```solidity
function setHintDelegated(address _namespace, bytes32 calldata _entry, bool _isTrusted) public;
```
...
```solidity
function setHintDelegatedSigned(address _namespace, bytes32 calldata _entry, bool _isTrusted, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setHintsDelegated(address _namespace, bytes32 _list, bytes32 _key, bytes32[] calldata _values) public;
```
...
```solidity
function setHintsDelegatedSigned(address _namespace, bytes32 _list, bytes32 _key, bytes32[] calldata _values, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setListStatus(address _namespace, bytes32 _list, bytes32 _key, bool _revoked) public;
```
...
```solidity
function setListStatusSigned(address _namespace, bytes32 _list, bytes32 _key, bool _revoked, address _signer, bytes calldata _signature) public;
```
...
```solidity
function setListOwner(address _namespace, bytes32 _list, bytes32 _key, address _newOwner) public;
```
...
```solidity
function setListOwnerSigned(address _namespace, bytes32 _list, bytes32 _key, address _newOwner, address _signer, bytes calldata _signature) public;
```
...
```solidity
function addListDelegateSigned(address _namespace, bytes32 _list, address _delegate, address _signer, bytes calldata _signature) public;
```
