...
discussions-to: https://github.com/ethereum/EIPs/pull/2502
status: Draft
...
This specifies the common interface for the delegations, and the address of the root delegation.
...
The root topic is used for defining a one address to all. This is very useful for managing of cold storage wallets, mutlisigs and other scenarios where regular voting becomes complicated.
...
Technically is the delegate of address zero, which appears when a delegate was not set.
