...
By default, at root delegation, all users delegate to themselves, this is considered a circular delegation of size 0:
...
A circular delegation of size 1 would contain one user delegating to other:
