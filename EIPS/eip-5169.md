...
The project with contract, TokenScript and IoT firmware is in use by Smart Token Labs office door and numerous other installations. An example implementation contract: [EIP-5169 Contract Example](../assets/eip-5169/contract/example5169contract.sol) and TokenScript:  [EIP-5169 TokenScript Example](../assets/eip-5169/tokenscript/example5169script.xml). Links to the firmware and full sample can be found in the associated discussion linked in the header.
