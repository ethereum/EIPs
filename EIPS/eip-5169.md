...
The project with contract (showing EIP5169), TokenScript and IoT firmware can be seen here: https://github.com/AlphaWallet/Web3E-Application/tree/master/New%20Office%20Door

The associated TokenScript can be read from the contract using `scriptURI()` here: https://ipfs.io/ipfs/QmYx9hi9n4UR2poAKwwFwH1uKJC8HzSvyXvMY5NFPsiysh
