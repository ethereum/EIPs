...
See also ["Implementing Account Abstraction as Part of Eth 1.x"](https://ethereum-magicians.org/t/implementing-account-abstraction-as-part-of-eth1-x/4020) and the links therein for historical work and motivation, and [EIP-2938](https://eips.ethereum.org/EIPS/eip-2938) for a consensus layer proposal for implementing the same goal.
...
* **Try to support other use cases**
    ...
    * Pay tx fees with ERC-20 tokens, allow developers to pay fees for their users, and [EIP-3074](https://eips.ethereum.org/EIPS/eip-3074)-like **sponsored transaction** use cases more generally
