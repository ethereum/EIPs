...
This proposal defines Intent Abstract NFT(IA-NFT), which enables NFT to own its defined logic and possesses composability.
...
- **IA-NFT Serves as a Foundational Component to Facilitate Lightweight DAPPs**

  In contrast to enduring lengthy development and promotional phases, IA-NFT offers individual developers the option to develop simplified contract functionalities and leverages existing NFT infrastructure for the marketization.
...
With IA-NFT, one IA-NFT represents one functional module and is reusable and composable at the same time.
