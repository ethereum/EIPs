...
1. This token introduces a communication model for contracts that can be utilized to straighten the behavior of contracts that interact with tokens as opposed to [ERC-20](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md) where a token transfer could be ignored by the receiving contract.
