...
#### Specification: Print (Child) NFTs
...
#### Specification: NFT Payment Tokens
...
#### Rationale: Contract Constructor and Global Variables and their update functions
...
#### Specification: Contract Constructor and Global Variables and their update functions
...
#### Rationale: Get a Royalty Account
...
#### Specification: Get a Royalty Account
...
#### Rationale: Update a Royalty Account
...
#### Specification: Update a Royalty Account
...
#### Rationale: Deleting a Royalty Account
...
#### Specification: Deleting a Royalty Account
...
#### Rationale: Listing and De-Listing of NFTs for Direct Sales
...
#### Specification: Listing and De-Listing of NFTs for Direct Sales
...
#### Rationale: Payments for NFT Sales
...
#### Specification: Payments for NFT Sales
...
#### Rationale: Modified NFT Transfer Function
...
#### Specification: Modified NFT Transfer Function
...
#### Rationale: Distributing Royalties in the Transfer Function
...
#### Specification: Distributing Royalties in the Transfer Function
...
#### Rationale: Update Royalty Sub Account Ownership with Payout to approved Address (`from`)
...
#### Specification: Update Royalty Sub Account Ownership with Payout to approved Address (`from`)
...
#### Rationale: Removing the Payment Entry in `registeredPayment` after successful Transfer
...
#### Specification: Removing the Payment Entry in `registeredPayment` after successful Transfer
...
#### Rationale: Paying out Royalties to the `from` Address in `safeTransferFrom` Function
...
#### Specification: Paying out Royalties to the `from` Address in `safeTransferFrom` Function
