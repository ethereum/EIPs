...
* **Token Type**
    * Token Type is given as either ETH or the symbol of the supported EIP-20/223/777 tokens such as `DAI`
* **Asset ID**
...
The payment process depends on whether the payment is received in ETH or an EIP-20 token:
* EIP-20 Token
...
The Treetrunk reference implementation of the standard can be found under https://github.com/ethereum/EIPs/tree/master -> assets -> eip-4910 -> eip-4910-reference-implementation.
