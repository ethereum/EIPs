...
This proposal introduces several new concepts as extensions to the ERC721 standard that warrant explanation:
* **Royalty Account (RA)**
...
function listNFT (uint256[] calldata tokenIds, uint256 price, string calldata tokenType) public virtual returns (bool)
```
