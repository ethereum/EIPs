...
![Consensus layer net yield under the current curve and under the tapered issuance burn](../assets/eip-8361/yield-curve.svg)
...
![Annual ETH issuance under the current curve and under the tapered issuance burn](../assets/eip-8361/issuance-curve.svg)
...
![The staking ratio beyond which an operator's income falls as it adds stake](../assets/eip-8361/operator-threshold.svg)
...
![Net yield and annual issuance as the tapered issuance burn phases in over the transition](../assets/eip-8361/transition.gif)
