...
If the token would like to enable trait redemptions, the token MUST include the E RC-7496 <!-- [E RC-7496] (./e ip-7496.md) --> Dynamic Traits interface.
...
Tokens must properly implement E RC-7496 <!-- [E RC-7496] (./e ip-7496.md) --> Dynamic Traits to allow for trait redemptions.
