...
A more detailed motivation for this proposal can be found in the [README document](../assets/eip-7701/README).
...
A full list of rationales for the decisions made in this proposal can be found in the [README document](../assets/eip-7701/README).
