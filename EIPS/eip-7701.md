...
| 0x01   | current role                  |
| 0x02   | `sender`                      |
| 0x03   | `senderValidationData`        |
| 0x04   | `deployer`                    |
| 0x05   | `deployerData`                |
| 0x06   | `paymaster`                   |
| 0x07   | `paymasterData`               |
| 0x08   | `senderExecutionData`         |
| 0x09   | `builderFee`                  |
| 0x0A   | `maxPriorityFeePerGas`        |
| 0x0B   | `maxFeePerGas`                |
| 0x0C   | `senderValidationGasLimit`    |
| 0x0D   | `paymasterValidationGasLimit` |
| 0x0E   | `senderExecutionGasLimit`     |
| 0x0F   | `paymasterPostOpGasLimit`     |
| 0x10   | `accessList` hash             |
| 0x11   | `authorizationList` hash      |
| 0x12   | `executionStatus`             |
| 0x13   | `actualGasCost`               |
