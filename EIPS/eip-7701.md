...
| 0x09   | `builderFee`                  | 32          |
| 0x0A   | `maxPriorityFeePerGas`        | 32          |
| 0x0B   | `maxFeePerGas`                | 32          |
| 0x0C   | `senderValidationGasLimit`    | 32          |
| 0x0D   | `paymasterValidationGasLimit` | 32          |
| 0x0E   | `senderExecutionGasLimit`     | 32          |
| 0x0F   | `paymasterPostOpGasLimit`     | 32          |
| 0x10   | `accessList` hash             | 32          |
| 0x11   | `authorizationList` hash      | 32          |
| 0x12   | `executionStatus`             | 32          |
| 0x13   | `actualGasCost`               | 32          |
