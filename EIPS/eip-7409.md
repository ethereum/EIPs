...
> :information_source: **[ERC-7831](./eip-7831.md) has superseded [ERC-6831](./eip-6831.md).** :information_source:  
> [ERC-7831](./eip-7831.md) fixes the compatibility issue in the [ERC-6831](./eip-6831.md) interface specification, where the UNIX emotjis are represented using `bytes4` values. The introduction of variation flags and emoji skin tones has rendered the `bytes4` namespace insufficient for representing all possible emojis, so the new standard used `string` instead.
> Apart from this fix, [ERC-7831](./eip-7831.md) is functionally equivalent to [ERC-820](./eip-7831.md).
>
> :warning: [ERC-7831](./eip-7831.md) MUST be used in lieu of [ERC-6831](./eip-6831.md). :warning:
