...
### resolveDispute
  `function resolveDispute(bytes32 incentiveId, bytes calldata disputeResolutionInfo)`
...
### disputeResolved
  ...
  event disputeResolved(bytes32 incentiveId, address indexed plaintiff, address indexed defendant, bool indexed dismissed)
