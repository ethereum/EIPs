---
eip: 1485
title: TEthashV1, Trust Ethash Version 1
...
The following is a proposal for an alternate proof-of-work algorithm - **“TEthashV1”** -  tuned for commodity hardware in order to close the efficiency gap available to specialized ASICs.
...
Provide minimal set of changes to Ethash algorithm to update FNV0 algorithm for obsolete ASIC mining.
...
#### 2. Current ETHash FNV Hash Implementation is depricated now. 
