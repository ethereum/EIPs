...
#### 2. Current Applied ETHash FNV Hash Implementation is depricated now. [FNV-0_hash (deprecated)]("https://en.wikipedia.org/wiki/Fowler%E2%80%93Noll%E2%80%93Vo_hash_function#FNV-0_hash_(deprecated)")
