...
discussions-to: https://ethereum-magicians.org/t/eip-7231
status: Draft
...
![EIP Flow Diagram](https://github.com/xuxinlai2002/EIPs/blob/master/assets/eip-7231/img/Identity-aggregated-NFT-flow.png)
...
1. Verify the binding relationship between data on-chain and off-chain data through signature based on ERC-1271
...
Tests are included in [`erc7231.ts`](https://github.com/xuxinlai2002/EIPs/blob/master/assets/eip-7231/test/erc7231.ts).
...
`ERC7231.sol` Implementation: [`ERC7231.sol`](https://github.com/xuxinlai2002/EIPs/blob/master/assets/eip-7231/contracts/ERC7231.sol)
