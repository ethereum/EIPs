...
author: Chloe Gu (@xy_gu), Navid Xu (@carv.io), Victor Yu (@carv.io), Archer H.
...
As mentioned in the specifications section, this standard can be fully [EIP-7211](./eip-721.md) compatible by adding an extension function set.
In addition, new functions introduced in this standard have many similarities with the existing functions in [EIP-721](./eip-721.md). This allows developers to easily adopt the standard quickly.
