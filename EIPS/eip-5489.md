...
## Motivation
As NFTs attract more and more user attention, NFTs have the potential to evolve towards becoming the decentralized medium for Web3. But there are some missing core components, such as how to attach and exhibit highly customized information on this medium (NFT). For example, end users can’t attach rich texts, videos or images on NFTs, also there’s no way to exhibit these rich-content attachments on NFTs.

This proposal try to answer this question, it tries to use hyperlink as the main form of “highly customized attachment on NFT”.
