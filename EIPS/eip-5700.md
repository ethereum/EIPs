...
An EIP-721 implementation supporting "delegated" and "legacy" binding modes can be found [here](../assets/eip-5700/erc721).
An EIP-1155 implementation supporting only the "delegated" binding mode can be found [here](../assets/eip-5700/erc1155).
