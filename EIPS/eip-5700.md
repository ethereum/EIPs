...
A bound asset ("binder") has few restrictions on how it is represented, except that it be unique and expose an interface for ownership queries. A binder would most commonly be represented as an ERC-721 NFT. Binders and bindables form a one-to-many relationship.
...
For a reference EIP-721 implementation supporting "delegated" and "legacy" binding modes:
* [EIP-721 Bindable](../assets/eip-5700/erc721/ERC721Bindable.sol).
* [EIP-721 Binder](../assets/eip-5700/erc721/ERC721Binder.sol).

For a reference EIP-1155 implementation supporting only the "delegated" binding mode:
