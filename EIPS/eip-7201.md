...
The storage location for a namespace is defined as `ns_loc(id: string) = align256(keccak256(uint256(align256(keccak256(id))) - 1))`, where `align256(x: bytes32) = x & ~0xff`.
