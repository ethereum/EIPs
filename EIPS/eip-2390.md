...
used on other interfaces like IPFS content hash storage [EIP-1162](./eip-1162.md).
...
In addition to geographic split horizon DNS, GeoENS can be used for the following:
 ...
 - ENS + IPFS web hosting (as described in [EIP-1162](./eip-1162.md)) with content translated to the native language of the query source.
