...
The 9 blocks including and after the activation block (so block 1,920,000 - 1,920,009) must have "dao-hard-fork" (`0x64616f2d686172642d666f726b`) in the `extraData` field of the block.
