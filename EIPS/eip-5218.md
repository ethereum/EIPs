...
The license `URI` may point to a JSON file that conforms to the "ERC5218 Metadata JSON Schema" as below, which adopts the "three-layer" design of the Creative Commons Licenses:
...
Test cases are available [here](../assets/eip-5218/test/Contract.t.sol).
...
The complete implementation can be found [here](../assets/eip-5218/contracts/RightsManagement.sol). 
