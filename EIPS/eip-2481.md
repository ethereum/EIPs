...
```json
{
  "type": "eth.GetBlockHeadersPacket66",
...
```json
{
  "type": "eth.GetBlockBodiesPacket66",
...
```json
{
  "type": "eth.BlockBodiesRLPPacket66",
  "rlp": "",
  "data": {
    "RequestId": 1111,
    "BlockBodiesRLPPacket": [
      ""
    ]
  }
}
```
...
```json
{
  "type": "eth.ReceiptsRLPPacket66",
  "rlp": "",
  "data": {
    "RequestId": 1111,
    "ReceiptsRLPPacket": [
      ""
    ]
  }
}
```
```json
{
  "type": "eth.GetPooledTransactionsPacket66",
  "rlp": "0xf847820457f842a000000000000000000000000000000000000000000000000000000000deadc0dea000000000000000000000000000000000000000000000000000000000feedbeef",
  "data": {
    "RequestId": 1111,
...
```json
{
  "type": "eth.PooledTransactionsPacket66",
...
```json
{
  "type": "eth.PooledTransactionsRLPPacket66",
  "rlp": "",
  "data": {
    "RequestId": 1111,
    "PooledTransactionsRLPPacket": [
      "+GcIhQSoF8gIgwLiSJQ1NTU1NTU1NTU1NTU1NTU1NTU1NYICAIAloGSxcC2SmP7mLf7MxX0yKkY61VyiASVtAfYrRbLhwhwSoGSxcC2SmP7mLf7MxX0yKkY61VyiASVtAfYrRbLhwhwQ",
      "+GcJhQSoF8gJgwM0UJQ1NTU1NTU1NTU1NTU1NTU1NTU1NYIC2YAloFL49hIBsrEaeNboZqvJw9sq6GMfpla/5ctTZoJVNnr7oFL49hIBsrEaeNboZqvJw9sq6GMfpla/5ctTZoJVNnr7"
    ]
  }
}
```
