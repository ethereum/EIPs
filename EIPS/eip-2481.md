...
To elaborate, each command is altered by adding a `request_id` as the first element. 
...
```json
{
  ...
  "rlp": "0xe7820457a000000000000000000000000000000000000000000000000000000000deadc0de050580",
  "data": {
    "RequestId": 1111,
    "Origin": {
