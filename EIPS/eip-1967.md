...
Holds the address of the beacon contract this proxy relies on (fallback). This is an alternative to the logic contract slot, and should only be considered if the logic contract slot is not set. See the **Beacons** section below.
