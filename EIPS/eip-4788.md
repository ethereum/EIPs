...
| `BEACON_ROOTS_ADDRESS`       | `0x89e64Be8700cC37EB34f9209c96466DEEDc0d8a6` |
...
Additionally, `BEACON_ROOTS_ADDRESS` must be added to the [EIP-2929](./eip-2929.md) `accessed_addresses` list at the start of transaction execution.
