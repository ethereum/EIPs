...
In order to bound the storage used by this precompile, two ring buffers are used: one to track the latest timestamp at a given index and another to track
