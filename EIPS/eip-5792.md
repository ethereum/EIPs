...
description: Adds JSON RPC methods for sending multiple function calls from a wallet in a single call and checking on
the status of those bundles
...
This problems becomes worse with account abstracted wallets (e.g. [EIP-4337](./eip-4337.md)
...
to be relevant to the actual transaction hash of the included transaction.
