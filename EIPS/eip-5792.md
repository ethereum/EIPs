...
If a wallet has affirmatively expressed this `atomicBatch` capability, it MUST submit calls submitted with `wallet_sendCalls` as part of a single transaction to conform with this specification.
