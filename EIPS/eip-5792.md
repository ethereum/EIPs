...
* `atomic` means that the wallet will execute the calls as part of a single transaction.
* `nonAtomic` means that the wallet will execute the each call as an individual transaction.
