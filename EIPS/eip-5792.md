...
support bundled transactions via [EIP-3074](./eip-3074.md). Dapps may transition to use these more abstract methods to
support different kinds of wallets, and provide a better UX for sending bundles of transactions.
...
The goal of the new API is to be a more stable and flexible interface while wallet implementations evolve over time.
