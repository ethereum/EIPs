...
Reducing the amount of clicks end-users need to make to interact with Ethereum applications is crucial to improving the end-user experience. This is especially important for mobile-first applications where a signature usually requires end-users to switch context into their wallet applications.
...
Wallets can advertise their support for these methods quite easily via the CAIP-25 response alongside of the other methods they already advertise as follows:
