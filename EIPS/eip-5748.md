...
author: Go+ Security (@GoPlusSecurity), Jeff Hall <642706757@qq.com>, Xavi (@XaaaaavitheFool), Turan Vural (@turanzv)
discussions-to: <https://ethereum-magicians.org/t/automatic-expiration-of-token-approvals/11185>
status: Draft
