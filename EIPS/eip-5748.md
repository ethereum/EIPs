...
The above modifications adds a validity period to [ERC-20](./eip-20.md) token approvals. Users can freely update their allowance validity at any time by calling `approve(address spender, uint256 amount, uint256 period)`.
...
This standard is compatible with the [ERC-20](./eip-20.md), [ERC-721](./eip-721.md) and [ERC-1155](./eip-1155.md) standards. Tokens issued in the form of proxy contracts can be updated to comply with this standard.
...
When upgrading a standard [ERC-20](./eip-20.md)-based proxy contract to this standard, attention should be paid to the location of assets.
