...
* EXP (`C00A`): `a EXP b mod 2^64`, gas cost is the same as non-64-bit mode EXP.
...
* For `DUP*`, the value duplicated on the stack will only have the least significant 64 bits copied. The most significant 192 bits, when observable, are zero. For example, DUP1 with stack `[ value ]` will be `[ value mod 2^64, value ]`.
...
* `[ff000000 00000000 000000ff 00000001, ff000000 00000000 000000ff f000000f] C0 SHR [<0> 78000007]
