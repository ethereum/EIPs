...
This EIP formalizes an Ethereum Provider JavaScript API for consistency across clients and applications. The provider is designed to be minimal and compatible cross environments.
...
class EthereumProvider extends EventEmitter {
  constructor(transport) {
    ...
    this._transsport.on('message', this._handleJsonrpcMessage.bind(this));
  }
