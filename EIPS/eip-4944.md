...
description: An [ERC-721](./eip-721.md) compatible single-token NFT
...
This change would enable automatically all the capabilities of composable tokens ERC-998 (own other ERC-721 or ERC-20) natively without adding any extra code, just forbidding to mint more than one token per deployed contract.
