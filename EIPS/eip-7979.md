...
class EVMOpcode:
    PUSH1 = 0x5f  # Note: PUSH0 is 0x5f; 0x60 is PUSH1
    PUSH32 = 0x7f
    JUMP = 0x56
    JUMPI = 0x57
    CALLSUB = 0xB0
...
class Validator:
    ...
    def _validate_recursive(self, pc: int, height: int, last_push: Optional[int]) -> bool:
        ...
        if op in (EVMOpcode.JUMP, EVMOpcode.JUMPI):
        ...
        # For non-terminating instructions, prepare next instruction
            ...
            push_val = val if EVMOpcode.PUSH1 <= op <= EVMOpcode.PUSH32 else None
