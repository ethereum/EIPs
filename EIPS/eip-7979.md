...
Therefore this proposal _does not_ require a client to maintain two interpreters — the interpreter need not care whether the code is `valid`.  _Neither does this proposal require a client to implement validation code — it will already be on the blockchain._  So the implementation can come down to a push and a jump to call, and a pop and another jump to return.
