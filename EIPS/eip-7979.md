...
There is an entire academic literature devising complex, partial solutions to problems that this proposal renders trivial.  With so much at stake on the blockchain deploying correct contracts is imperative -- there is no reason for the EVM to make the job any more difficult than necessary.
...
** Note: these tests have not yet caught up to the spec. **
