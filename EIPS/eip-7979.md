...
In 2016 the lead author set out to write a compiler from EVM code to machine code.  I was immediately stymied by the presence of dynamic jumps. _Dynamic jumps must die._
...
The ACE supported calls directly with a stack of mercury-filled memory crystals holding return addresses.  Turing's ACE design was a 32-bit RISC machine with integer hardware and floating point microcode, 32 32-bit registers, a 1024-entry return stack, and 25K of RAM on a 1 MHz bus.  The smaller Pilot ACE was for a while the world's fastest computer.
...
Consider these three programs.  It is impossible to know where the jumps go.
