...
These changes do not foreclose EOF, RISC-V, or other changes. Neither do these changes preclude running the EVM in zero knowledge; as explained in [EIP-xxxx: Static Control Flow in the EVM — Foundational Concepts and Context](./eip-xxxx) they can instead be a big win.
