...
This would of course break the promise of "the smallest possible change."  [EIP-4200: EOF - Static relative jumps](https://eips.ethereum.org/EIPS/eip-4200) and [EIP-4750: EOF - Functions](./eip-4750) remain available.  If backwards compatibility is to be maintained this proposal will be still be needed.
