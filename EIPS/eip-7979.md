...
In 1883 Charles Babbage began the design of what would have been a Turing-complete, steam-powered, mechanical computer.  It's first published description was the _Sketch of The Analytical Engine Invented by Charles Babbage", L. F. MENABREA of Turin, Officer of the Military Engineers from the Bibliothèque Universelle de Genève, October, 1842, No. 82 With notes upon the Memoir by the Translator ADA AUGUSTA, COUNTESS OF LOVELACE._ Those notes include the Countess' famous computer program, which used conditional jumps and loops to recursively compute Bernoulli numbers.

In 1945 Alan proposed calls, and returns as a means of organizing the logic of the code and the design of the memory crystals for his Automatic Computing Engine:
...
This would of course break the promise of "the smallest possible change."  [EIP-4200: EOF - Static relative jumps](./eip-4200) and [EIP-4750: EOF - Functions](./eip-4750) remain available.

### Why no object format?

Again, this would break the promise of "the smallest possible change."  Validation already provides for most of the semantic guarantees that EOF Functions provide, and [EIP-3540: EOF - EVM Object Format](./eip-3540) remains available. In the presence of EOF code sections `CALLSUB` would be restricted to section boundaries.
