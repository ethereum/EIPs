...
In 1945 Alan Turnong proposed calls, and returns as a means of organizing the logic of the code and the design of the memory crystals for his Automatic Computing Engine:
...
1. Decode the `destination` UTF8-encoded positive integer.
...
This would of course break the promise of "the smallest possible change."  [EIP-4200: EOF - Static relative jumps](./eip-4200) remains available if we want it's performance advantges.
