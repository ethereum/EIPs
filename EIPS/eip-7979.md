...
These changes do not foreclose EOF, RISC-V, or other changes.  New `MAGIC` numbers would future EVMs.  Neither do these changes preclude running the EVM in zero knowledge; they would more likely help.
