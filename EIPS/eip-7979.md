...
For Ethereum, quadratic traversal times are an online denial-of-service vulnerability that prevents us from ensuring `valid` use of EVM code and from compiling EVM code for faster execution.  Even offline, dynamic jumps cause the static analyses of many co tracts to become impractically slow, intractable or even impossible: 
