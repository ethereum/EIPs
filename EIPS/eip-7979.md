...
For detailed historical context, technical foundations of static control flow, and their impact on Ethereum's scaling roadmap, see [[EIP-8173][EIP-8173](./eip-8173.md): "Static Control Flow for the EVM.  "
...
* *Immediate arguments* for jump destinations would improve performance but increase complexity.  See [EIP-8013: Static relative jumps and calls for the EVM](./eip-8013) for a complementary proposal using immediate arguments.  See [EVM Immediates](https://ethereum-magicians.org/t/evm-immediates/25605) for a discussion of backwards-compatible ways to add intermediates to the EVM.
