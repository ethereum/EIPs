...
eip: 8235
title: EIP tagging
description: Adds required tags for EIPs
...
Introduce a was to tag EIPs with well-known specifics on what the EIP affects and defines governance rules on the addition and removal of these tags.
...
EIPs must define tags within the EIP preamble under the `tags` key.
