...
By using the this ERC standard to separate concerns (decouple account and control logic), individuals and organizations are able to:
...
This ERC consists of four key concepts:
