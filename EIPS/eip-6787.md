---
eip: 6787
title: Order Book DEX Standard
description: A standard order book-based DEX that ensures the asset security of both users and the exchange through a two-phase forced withdrawal mechanism.
author:  Jessica Zheng(@qizheng09), Jun Ji(@SniperUsopp), Roy(@royshang), Ethan(@ledgerhappy), Ricky(@hbthlw)
