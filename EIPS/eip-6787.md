...
The settle interface has different implementations for different order book exchanges, and here is an example. When implements the business, you can also perform settle operations for batch users or multiple currencies.
