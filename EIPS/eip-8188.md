...
discussions-to: <TODO add this later>
status: Draft
...
[EIP-8038](./eip-8038.md) explicitly recognizes that state access has become slower as state grows and therefore updates baseline state-access gas parameters. This proposal extends that direction by pricing _renewal age over time_.
...
- **`SELFDESTRUCT` / account clearing**: set `last_written_period = current_period`.
