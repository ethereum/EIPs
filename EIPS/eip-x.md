...
Tests are included in [`attributesRepository.ts`](../assets/eip-XYZ/test/attributesRepository.ts).
...
See [`AttributesRepository.sol`](../assets/eip-XYZ/contracts/AttributesRepository.sol).
