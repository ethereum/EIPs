---
eip: <to be assigned>
title: EIP-4907 Alternative Design
description: Add a time-limited role with restricted permissions to ERC-721 tokens.
author: Anders (@0xanders), Lance (@LanceSnow), Shrug <shrug@emojidao.org>, Tim Daubenschütz (@TimDaub)
discussions-to: https://ethereum-magicians.org/t/idea-erc-721-user-and-expires-extension/8572
status: Final
type: Standards Track
category: ERC
created: 2022-03-11
requires: 165, 721, 4907
---

## Abstract

It was noted that [EIP-4907](./eip-4907.md) was somewhat inconsistent with [EIP-721](./eip-721.md). This EIP addresses those inconsistencies. Otherwise, this EIP is identical to EIP-4907.
...
interface IERC4907 {
    ...
    /// @dev The zero address indicates that the user is expired
    /// Throws if `tokenId` is not valid NFT
...
contract ERC4907 is ERC721, IERC4907 {
    ...
    function userOf(uint256 tokenId) public view virtual returns(address){
        ownerOf(tokenId) // Make sure that the tokenId exists
