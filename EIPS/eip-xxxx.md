...
`DATALOAD`, `DATASIZE`, `DATACOPY` instructions combination follows the design of existing instructions for reading other kinds of data (return data, call data).
