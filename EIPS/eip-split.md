...
Ild ERC links pointing to the old
url [https://eips.ethereum.org/](https://eips.ethereum.org/) will continue to
work. Redirect instructions will be put into place to redirect to the new ERC
...
This proposal only addresses the EIP and ERC proposal process and is not expected
