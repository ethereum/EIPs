...
discussions-to: https://ethereum-magicians.org/t/eip-7292-purpose-bound-money/14973
status: Draft
...
This proposal outlines a smart contract interface that builds upon the [ERC-1155](./eip-1155.md) standard to introduce the concept of a purpose bound money (PBM) defined in the [Project Orchid Whitepaper](../assets/eip-7292/MAS-Project-Orchid.pdf) and [PBM Technical Whitepaper](../assets/eip-7292/PBM-Technical-Whitepaper.pdf).
...
Reference implementations can be found in [`README.md`](../assets/eip-7292/README.md).
