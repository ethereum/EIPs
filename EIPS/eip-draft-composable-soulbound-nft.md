...
Test cases are included in [test.js](../assets/eip-draft-composable-soulbound-nft/test/test.js). 

Run in terminal:

```shell
cd ../assets/eip-draft-composable-soulbound-nft
npm install
npx hardhat test
```

Test contract are included in [Demo.sol](../assets/eip-draft-composable-soulbound-nft/contracts/Demo.sol). 

## Reference Implementation

See [`ComposableSoulboundNFT.sol`](../assets/eip-draft-composable-soulbound-nft/contracts/ComposableSoulboundNFT.sol).
