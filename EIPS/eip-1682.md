...
The proposed changes try to fit within the existing state transition model. Note that
...
and their rent requirements in an auxiliary data structure otherwise.
