...
description: Minimal on-chain interface for AI agents to anchor verifiable proofs and build portable reputation
...
The interface complements ERC-8004 (agent identity) and Visa TAP (trusted
...
1. **Identity is not Accountability.** ERC-8004 and Visa TAP solve "who", not
...
This EIP defines a recommended 12-dimension schema (3 layers x 4 axes)
