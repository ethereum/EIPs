...
| `0x00` Explicit (sandbox) | 6,000 + scan cost + metered execution gas | 1 SLOAD (key_config) + overhead + cold code access + header/opcode safety scan + sandbox execution (metered; nodes SHOULD enforce a per-verifier gas cap) |
...
Bytecode header:
  Byte 0:    0x60         PUSH1
  Byte 1:    0x06         (jump offset)
  Byte 2:    0x56         JUMP
  Byte 3-4:  0x81 0x30    magic ("8130")
  Byte 5:    version      uint8 (interface version)
  Byte 6:    0x5B         JUMPDEST
  Byte 7+:   verification code
```
