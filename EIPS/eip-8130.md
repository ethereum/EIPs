...
6. Validate `sender_signature` against `initial_keys[key_index]`
...
3. If `account_initialization` is non-empty:
   ...
   - Validate `sender_signature` against `initial_keys[key_index]`
4. Else validate `sender_signature` against sender's keys:
