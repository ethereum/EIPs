...
As a convention, a `metadata` field that is exactly 32 bytes SHOULD be interpreted as a commitment (a digest) to data stored off-chain, rather than as an inline structured payload.
