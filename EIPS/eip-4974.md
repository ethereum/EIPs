...
## Abstract
The following describes a standard interface for assignment of numerical experience points, or EXP. This standard provides basic functionality for participant addresses to consent to receive points and for an operator address to transfer tokens.
