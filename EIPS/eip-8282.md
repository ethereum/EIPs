...
Test cases will be provided with the reference implementation, once the predeploy contracts are finalized.

## Reference Implementation

The contracts will be developed and finalized as system-contract sources, against which the deployed runtime bytecode must reproduce.
