...
A signer MAY be specified to provide a signature to process the redemption. If the signer is NOT the null address, the signature MUST recover to the signer address via [EIP-712](./eip-712.md) or [EIP-1271](./eip-1271.md).
