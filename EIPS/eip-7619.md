...
description: Proposal to add precompiled contract that allows generic signature verifications using Falcon512 postquantum algorithm
...
The following table shows a summary of the typicall values for keys and the approximate amount of time taken per second to execute signature verifications as specified by the authors of Falcon algorithm:
...
- The reference implementation for the precompiled signature using Falcon can be found for the Go-Ethereum client and for Hyperledger Besu.
