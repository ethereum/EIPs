---
eip: TBD
title: JSON-RPC Method for Transaction Gas Limit Cap
description: Add an RPC method to query the EIP-7825 transaction gas limit cap
author: Paul Razvan Berg (@PaulRBerg)
discussions-to: https://ethereum-magicians.org/t/eip-xxxx-add-rpc-method-for-querying-the-eip-7825-transaction-gas-limit-cap/27417
status: Draft
...
- and there are already proposals to make the transaction gas limit cap dynamic, rather than hardcoded, based on new
  fee calculation rules (see this [EIP draft](https://ethereum-magicians.org/t/eip-tba-increasing-transaction-gas-limit-with-a-new-fee-calculation-rule/27249)).
