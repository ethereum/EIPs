...
Process logic of SDC can be implemented as a finite state machine on solidity. An erc-20 token can be used for frictionless decentralized settlement, see reference implementation.
