...
Process logic of SDC can be implemented as a finite state machine on solidity. An EIP-20 token can be used for frictionless decentralized settlement, see reference implementation.
...
Live-cycle unit tests based on the sample implementation and usage of EIP-20 token is provided. See folder /assets/test.
