...
Life-cycle unit tests based on the sample implementation and usage of [ERC-20](./erc-20.md) token is provided. See file [test/SDCTests.js](../assets/eip-6123/test/SDCTests.js)
).
