...
| Word | Meaning |
| ---- | ------- |
| word | a value whose size is the amount of data a client CPU's internal data registers can hold and process at one time |
...
Example: [Gnark](https://hackmd.io/@gnark/modular_multiplication) Montgomery multiplication optimization when the most significant bit of the modulus is 0 which reduced runtime by 20%.
