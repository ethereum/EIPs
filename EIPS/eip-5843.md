...
## Motivation
Additional crypto precompiles have long been desired for the EVM. Among these, operations for various elliptic curves have been proposed and not yet adopted ([BLS12-381](./eip-2537.md), [BW6-761](./eip-3026.md), [MNT4](./eip-1895.md), [Baby Jubjub](./eip-2494.md)).  Other EIPs (such as [EIP-1962](./eip-1962.md) and [EIP-1829](./eip-1829.md)) have tried to propose more generic operations which can take curve parameters as inputs.
...
* They introduce complicated algorithms into the Ethereum protocol which are not understood by most client developers, and often lack good explanatory resources beyond academic papers.
    * other than cryptography, input deserialization and gas-charging logic are other sources of added protocol surface that can potentially introduce consensus bugs.
