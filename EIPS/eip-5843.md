...
depends on:
* https://eips.ethereum.org/EIPS/eip-3540 - useful because we can use the versioning provided by EOF containers to modify jumpdest-analysis that this EIP requires without breaking backwards compatibility.
