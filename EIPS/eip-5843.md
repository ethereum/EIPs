...
`MAX_VALUE_SIZE` is tentatively set to 16.  Use cases such as 2048/4096bit RSA verification are not possible to implement with using EVMMAX unless the limit is raised.
