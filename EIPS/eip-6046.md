...
All the rpoposals would leave data in the state, but this proposal provides the flexibility to reuse or remove storage slots ony-by-one should the revived contract choose to do so.
