...
However, if you only spend 1M gas allocating memory in each context, and make calls to reset the memory, you can allocate ~700KB per million gas, for a total of ~21MB of memory allocated:
