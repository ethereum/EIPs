...
Gas costs are based on [EIP-1962](./eip-1961.md) estimation strategy (but do not fully include yet parsing of ABI, decoding and encoding of the result as a byte array).
