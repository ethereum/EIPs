...
[EIP-7685](https://eips.ethereum.org/EIPS/eip-7685), decreasing the complexity of adding
...
[EIP-7251](https://eips.ethereum.org/EIPS/eip-7251), the target validator withdrawal
...
- New Beacobn State mutator method: `update_withdrawal_credentials`
