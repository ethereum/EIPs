...
description: Support performant and cheap verification of Ed25519 cryptographic signatures in smart contracts in general by adding  precompiled contracts for Ed25519 signature verification to the EVM.
...
* At last, as part of FIDO allowed algorithms(`https://fidoalliance.org/specs/fido-security-requirements-v1.0-fd-20170524/fido-authenticator-allowed-cryptography-list_20170524.html
## Reference Implementation), using Ed25519 together with EIP-4337 can provide the secure enclave biometric gated WebAuthn implementations such as Touch ID/Face ID. 
...
The reference for mathematical specification is RFC8032. Reference vectors are provided in IETF(`https://tools.ietf.org/html/draft-josefsson-eddsa-ed25519-03#section-6`).
...
[FCL], see `https://github.com/rdubois-crypto/FreshCryptoLib/blob/master/solidity/FCL_eddsa.sol`, is a library providing optimized ECC implementations for secp256r1 and ed25519 (both being part of FIDO). Current implementation has a 206K gas cost.
...
5. [FCL-solidity]`https://github.com/rdubois-crypto/FreshCryptoLib/blob/master/solidity/FCL_eddsa.sol`
...
* [FIDO]`https://fidoalliance.org/specs/fido-security-requirements-v1.0-fd-20170524/fido-authenticator-allowed-cryptography-list_20170524.html` FIDO Authenticator Allowed Cryptography List.
* [FIPS 186-5]`https://csrc.nist.gov/pubs/fips/186-5/final` Digital Signature Standard (DSS). 
* [RFC7748]`https://tools.ietf.org/html/rfc7748` - Elliptic Curves for Security 
...
* [IETF]`https://tools.ietf.org/html/draft-josefsson-eddsa-ed25519-03#section-6` - Test vectors for Ed25519: 
