...
* At last, as part of FIDO allowed [algorithms](https://fidoalliance.org/specs/fido-security-requirements-v1.0-fd-20170524/fido-authenticator-allowed-cryptography-list_20170524.html), using Ed25519 together with EIP4337 can provide the secure enclave biometric gated WebAuthn implementations such as Touch ID/Face ID. 
...
For equity and interoperability, this EIP set the cost to the same price.
...
[FCL](https://github.com/rdubois-crypto/FreshCryptoLib/blob/master/solidity/FCL_eddsa.sol) is a library providing optimized ECC implementations for secp256r1 and ed25519 (both being part of FIDO). Current implementation has a 206K gas cost.
