...
Despite being around only for some years, post-Snowden, these curves have gained wide use (as listed here: `https://ianix.com/pub/ed25519-deployment.html`) in various protocols and systems:
...
, using Ed25519 together with [ERC-4337](./eip-4337.md) can provide the secure enclave biometric gated WebAuthn implementations such as Touch ID/Face ID. 
