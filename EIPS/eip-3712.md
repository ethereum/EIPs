...
ERC-3712 has a global authorization function. Compared with ERC20, extra attention needs to be paid to the use of this function. If it is authorized for use by inappropriate addresses, it will cause serious losses.
