...
An EIP **MUST** have an implementation in [execution-specs](https://github.com/ethereum/execution-specs) in an open PR to <WHICH BRANCH?> or merged to <SAID BRANCH> before it can be moved to this stage.

An EIP **MUST** have an implementation of its tests in [execution-spec-tests](https://github.com/ethereum/execution-spec-tests) in an open PR to <WHICH BRANCH?> or merged to <SAID BRANCH> before it can be moved to this stage.
