...
1. All ERCs and Interface-category EIPs are removed from this repository and
   ...
   forked of this one with the non-ERCs removed. I've written a script (see
   below) to perform this operation. Once this PR is approved, it should be
   executed immediately before merging.
