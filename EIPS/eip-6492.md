...
- if the [ERC-1271](./eip-1271.md) verification fails, and `factory` was skipped because the wallet already had code, execute the `factoryCalldata` transaction and try `isValidSignature` again
