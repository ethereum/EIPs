...
This validation contract does not need to be deployed on-chain: on the contrary, it's designed to perform universal signature validation with support for this ERC, [ERC-1271](./eip-1271.md) and traditional `ecrecover` just by calling `eth_call` in a front-end verifier library.
