...
category: Core
created: 2026-08-03
requires: 161, 1014, 3529, 7610, 8037, 8038
---
...
Because target addresses are derived using the same rules as `CREATE2`, while all account state except balance is removed after transaction completion, such accounts become valid deployment targets again under [EIP-7510](./eip-7510.md).
