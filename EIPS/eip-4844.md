...
| `HASH_OPCODE_GAS` | `3` |
| [`MIN_EPOCHS_FOR_BLOB_SIDECARS_REQUESTS`](https://github.com/ethereum/consensus-specs/blob/master/configs/mainnet.yaml#L148) | `4096` |
...
This makes it easier to implement a policy that these blobs should be deleted after a certain period. The specific value chosen is `MIN_EPOCHS_FOR_BLOB_SIDECARS_REQUESTS` epocs, which is around 18 days, 
