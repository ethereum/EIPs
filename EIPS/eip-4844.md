...
category: Core
created: 2022-02-25
requires: 1559, 2718, 2930, 4895, 6475
---
...
`SignedBlobTransaction` container comprising the transaction contents. The definition uses the `Optional[T]` SSZ type as defined in [EIP-6475](./eip-6475.md).
...
class BlobTransaction(Container):
    ...
    gas: uint64
    to: Optional[Address] # Address = Bytes20
    value: uint256
