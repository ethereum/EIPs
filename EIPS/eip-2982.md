...
We use the swap-or-not shuffle described by Viet Tongue Hoang, Ben Morris, and Phillip Rogaway to shuffle the validator set and assign responsibilities every epoch. This algorithm ensures that:
