...
- Dydx's Balance ([code ref](https://github.com/dydxprotocol/perpetual/blob/13eea6201cd5a89814d1f90aae2382456289c2f3/contracts/protocol/v1/lib/P1Types.sol#L45-L50), uses `uint120`, no lossy compression).
