...
discussions-to: https://ethereum-magicians.org/t/erc-7652-onchain-audit-representation/15683
status: Draft
...
Audits are an integral part of the smart contract security framework. They are commonly used to ensure that smart contracts don't have bugs, follow best practises and correctly implement standards such [ERC-20](https://eips.ethereum.org/EIPS/eip-20) or [ERC-721](https://eips.ethereum.org/EIPS/eip-721)). Many essential parts of the Blockchain ecosystem are secured by smart contract by now. Some examples for this are:
...
- Why [ERC-712](https://eips.ethereum.org/EIPS/eip-712)?
    - [ERC-712](https://eips.ethereum.org/EIPS/eip-712) as a base for tooling compatibility (i.e. for signing)
