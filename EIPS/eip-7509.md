...
This proposal defines a minimal Entity Component System on Ethereum. Entities are unique identities that are assigned to multiple components (data) and then processed using the system (logic).
