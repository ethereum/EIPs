...
And as for the absolute amounts, clearly a full node should receive significantly less than a miner, but setting the amounts fairly will require data analysis.
