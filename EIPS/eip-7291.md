...
This proposal outlines a smart contract interface that builds upon the [ERC-1155](./eip-1155.md) standard to introduce the concept of a purpose bound money (PBM) defined in the [Project Orchid Whitepaper](../assets/eip-7291/MAS-Project-Orchid.pdf) and [PBM Technical Whitepaper](../assets/eip-7291/PBM-Technical-Whitepaper.pdf).
