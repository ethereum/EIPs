...
Field-to-curve call expects `64` bytes an an input that is interpreted as an element of the base field. Output of this call is `128` bytes and is G1 point following respective encoding rules.
