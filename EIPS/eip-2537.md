...
description: Precompiles for BLS12-381 curve operations
author: Alex Vlasov (@shamatar), Kelly Olson (@ineffectualproperty), Alex Stokes (@ralexstokes), hujw77 (@hujw77)
...
- One in Rust language that is based on the [EIP-1962](./eip-1962.md) code and integrated with OpenEthereum for this library
