...
It checks if the result of e(P1, Q1) \* e(P2, Q2) \* ... \* e(Pk, Qk) == 1 in the pairing target field where `e` is a pairing operation. Output is `32` bytes where first `31` bytes are equal to `0x00` and the last byte is `0x01`.
