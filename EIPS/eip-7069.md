...
2. Use the 63/64th rule, but
    2a. ensure that at least `MIN_RETAINED_GAS` gas is retained prior to executing the callee,
    2b. ensure that at least `MIN_CALLEE_GAS` gas is available to the callee.
