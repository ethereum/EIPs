...
- The synchronization of the `o-transactions` guarantees the ultimate consistency of token states across all chains. The related data structure is [ERC6358TransactionData](#data-structure).
...
- The implementation example of some common tools to operate ERC6358 can be found at:
...
- The implementation examples of ERC6358 Fungible Token and ERC6358 Non-Fungible Token can be found at:  
