...
In particular, changing either the recipient address or the amount transfered can be a profitable attack. Users should only use URLs received from authenticated sources with adequate integrity protection.
