...
author: Jay Logelin (@jlogelin), Infernal_toast <admin@0xbitcoin.org>, Michael Seiler <mgs33@cornell.edu>, Brandon Grill <bg2655@columbia.edu>
status: Last Call
...
This specification suggests using the keccak256/sha3 algorithm proof of work mechanism for its security hardness, explicitly certified by the National Institute of Standards and Technology (NIST) via FIPS 202. (https://csrc.nist.gov/publications/detail/fips/202/final).
