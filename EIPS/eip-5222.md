...
Test cases are available [here](../assets/eip-5222/contracts/test/Contract.t.sol).
...
In addition, the IC3 NFT License is specifically designed to work with this interface and provides a reference to the language of NFT root license.
