...
<img src="../assets/eip-5222/license-tree.png" alt="The license tree" width=45% />
...
The license `URI` may point to a JSON file that conforms to the "ERC5222 Metadata JSON Schema" as below, which adopts the "three-layer" design of the Creative Commons Licenses:
...
Test cases are available [here](../assets/eip-5222/test/Contract.t.sol).
...
The complete implementation can be found [here](../assets/eip-5222/contracts/RightsManagement.sol). 

In addition, the IC3 NFT License is specifically designed to work with this interface and provides a reference to NFT license language.
