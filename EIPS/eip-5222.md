...
The license `URI` may point to a JSON file that conforms to the "EIP5222 Metadata JSON Schema" as below, which adopts the "three-layer" design of the Creative Commons Licenses:
