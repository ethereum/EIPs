...
> :information_source: **[ERC-7059](./eip-7059.md) has superseded [ERC-6059](./eip-6059.md).** :information_source:  
> [ERC-7059](./eip-7059.md) fixes the inconsistency in the [ERC-6059](./eip-6059.md) interface specification, where interface ID doesn't match the interface specified as the interface evolved during the proposal's lifecycle, but one of the parameters was not added to it. The missing parameter is, however, present in the interface ID.
> Apart from this fix, [ERC-7059](./eip-7059.md) is functionally equivalent to [ERC-6059](./eip-6059.md).
>
> :warning: [ERC-7059](./eip-7059.md) MUST be used in lieu of [ERC-6059](./eip-6059.md). :warning:
...
![Nestable tokens](../assets/eip-7059/img/eip-7059-nestable-tokens.png)
...
```solidity
/// @title EIP-7059 Parent-Governed Nestable Non-Fungible Tokens
/// @dev See https://eips.ethereum.org/EIPS/eip-7059
...
1. **Reject child token**\
![Reject child token](../assets/eip-7059/img/eip-7059-reject-child.png)
2. **Abandon child token**\
![Abandon child token](../assets/eip-7059/img/eip-7059-abandon-child.png)
3. **Unnest child token**\
![Unnest child token](../assets/eip-7059/img/eip-7059-unnest-child.png)
4. **Transfer the child token to an EOA or an `ERC721Receiver`**\
![Transfer child token to EOA](../assets/eip-7059/img/eip-7059-transfer-child-to-eoa.png)
5. **Transfer the child token into a new parent token**\
![Transfer child token to parent token](../assets/eip-7059/img/eip-7059-transfer-child-to-token.png)\
...
Tests are included in [`nestable.ts`](../assets/eip-7059/test/nestable.ts).
...
See [`NestableToken.sol`](../assets/eip-7059/contracts/NestableToken.sol).
