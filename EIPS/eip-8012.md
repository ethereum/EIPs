...
This EIP redefines the field `target_pubkey` from consolidation requests into a general array of 48 bytes that can be interpreted separately by the consensus layer.
