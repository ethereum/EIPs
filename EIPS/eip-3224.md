...
- Format Strings (e.g. [Trustless Signing UI Protocol](https://github.com/ethereum/EIPs/issues/719)); format strings can only operate on the class of regular languages, which in many cases is insufficient to describe an Ethereum transaction. This was an issue quite often during [early attempts](https://github.com/ricmoo/distinguished-format-strings) at solving this problem
