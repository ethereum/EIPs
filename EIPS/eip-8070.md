...
The Engine API extensions `engine_blobCustodyUpdatedV1` and `engine_getBlobsV4` are specified in the [Execution APIs](https://github.com/ethereum/execution-apis) repository. See the [Amsterdam Engine API specification](https://github.com/ethereum/execution-apis/blob/main/src/engine/amsterdam.md) for details.
