...
* **Frontier Thawing**: 
* **[Homestead](./eip-606)**
* **[DAO Fork (DAO Wars - aborted)](./eip-779)**
...
* **[Dencún](./eip-7569)**: **Den**eb (CL) and Can**cún** (EL)
* **[Pectra](./eip-7600)**:  **P**rague (EL) and El**ectr**a (CL)
* **[Fusaka](./eip-7607)**: **Fu**lu (CL) and O**saka** (EL)
