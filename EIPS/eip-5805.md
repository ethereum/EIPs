...
The absence or the `clock()` or `CLOCK_MODE()` functions should be considered as a marker of the contract operating using block number. (This makes this EIP compatible with pre-existing voting contracts).
