...
description: Defines a mechanism on top of Sign-In With Ethereum to give informed consent to delegate capabilities with a certain extensible scope mechanism to an authorized delegee.
