...
Profile 1 needs the sender's nonce, balance, and code classification. Externally owned accounts (EOAs) with empty code and valid delegated EOAs can originate transactions; EIP-7702 delegated accounts cannot. Profile 1 does not execute code or consume the IL VERIFY budget.
