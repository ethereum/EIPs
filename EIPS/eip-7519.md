...
SCREDIT, which increments a storage slot, and SDEBIT, which decrements a storage
slot. Overflow and underflow errors are enforced, reverting when an unsigned
256-bit integer would overflow or underflow.
