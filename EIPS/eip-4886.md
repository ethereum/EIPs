 ...
 * Nominator address: The address that proposes a proxy relationship. This address nominates another address to act as it's proxy, representing it and  it's holdings in all interations.
