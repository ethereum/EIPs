...
|------|-------|-------------|
| `MAX_PAYLOAD_BLOBS_PER_BLOCK` | <!-- TODO --> TBD | Maximum number of blobs that may be used to encode the execution payload |
...
And the following methods from [polynomial-commitments-sampling.md](https://github.com/ethereum/consensus-specs/blob/3a2304981a3b820a22b518fe4859f4bba0ebc90b/specs/fulu/polynomial-commitments-sampling.md):

- [compute_cells_and_kzg_proofs](https://github.com/ethereum/consensus-specs/blob/3a2304981a3b820a22b518fe4859f4bba0ebc90b/specs/fulu/polynomial-commitments-sampling.md#compute_cells_and_kzg_proofs)
...
fn get_payload(payload_id: PayloadId) -> GetPayloadResponse:
    ...
    # 4. Compute blob commitments and cell proofs for payload blobs
...
fn get_payload_zk(payload_id: PayloadId) -> GetPayloadResponse:
    ...
    payload_cells_and_proofs = [compute_cells_and_kzg_proofs(b) for b in payload_blobs]
    payload_cell_proofs = [proofs for _, proofs in payload_cells_and_proofs]
    # Random point proofs for payload consistency verification (for PayloadBlobMetadata)
