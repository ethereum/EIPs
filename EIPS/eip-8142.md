...
Under the current protocol, transaction data is the only component of the execution payload that is not required by the consensus layer and cannot be derived from other components:
