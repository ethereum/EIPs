...
- The block builder commits to the payload columns with a Merkle root, which is included into the execution bid ([EIP-7732](./eip-7732.md)). Individual payload column sidecars carry Merkle multi-proofs rather than KZG proofs.
