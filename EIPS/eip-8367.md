...
TBD. Reference tests will be provided with the consensus-specs implementation, covering ceiling progression across the sunset window, clamp application to exited `0x00` balances, top-ups absorbed by the ceiling, credential rotation mid-window releasing the remaining balance, and the pre-start and post-end boundary epochs.
