...
## Implementation
The following implementation is an example which lacks trustless boolean slot and uses `NEXT_LOGIC_BLOCK_SLOT` instead of `UPGRADE_BLOCK_SLOT` to get farther slot value: [trust-minimized proxy](https://github.com/SamPorter1984/Aletheo/blob/main/contracts/avalanche%20mainnet/trust_minimized_proxy.sol)
