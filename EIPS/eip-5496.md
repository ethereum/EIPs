---
eip: 5496
title:  Multi-privilege Management Extension for EIP-721
description: Standard interface for creating sharable multi-privilege NFTs for EIP-721
...
ERC5496 is compatible with any kind of NFTs that follow the EIP-721 standard. It only adds more functions and data structures without interfering with the original EIP-721 standard.

## Test Cases
Test cases are implemented in the reference implementation
repository [here](https://github.com/wnft/ERC5496/tree/main/test)

## Reference Implementation
The following is a snippet for reference implementation of the `ERC5496` extension. The full repository can be
found [here](https://github.com/wnft/ERC5496/blob/main/contracts/ERC5496.sol)
...
Implementors of the `ERC5496` standard must consider thoroughly who has the permission to set or clone privileges.
