...
Every contract compliant to the `ERC5496` extension MUST implement the `IERC5496` interface. The **sharable multi-privilege extension** is OPTIONAL for ERC-721 contracts.

```solidity
/// @title multi-privilege extension for ERC-721
