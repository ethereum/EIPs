...
To invoke `function give(...)` and `function take(...)` an EIP-2098 compact signature must be created using EIP-712. A tested reference implementation is attached at [../assets/eip-4973/generateSignature.mjs](../assets/eip-4973/generateSignature.mjs) and [assets/eip-4973/generateSignature_test.mjs](assets/eip-4973/generateSignature_test.mjs).
