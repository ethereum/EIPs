...
The purpose of this document is to make SBTs a reality on Ethereum by creating consensus around a **maximally backward-compatible** but otherwise **minimal** interface definition.
...
Although other possible implementations of soulbound tokens are possible, e.g., by having all transfer functions revert, `ERC4973` is superior as it supports feature detection through [`ERC165`](./eip-165.md).
