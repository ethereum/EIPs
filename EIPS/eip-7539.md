...
There should be a framework for handling these extension cases both retroactively and in the future to improve ERC accessibility. Without this, ERC extensions may be introduced which break compatibility and composability in nontrivial ways. Entire classes of issues can be removed by having a strong definition and standard for what an Extension can and cannot change. 
