...
interface IERC5635Registry is IERC165 {
    ...
    /// @return _licenseIdentifier - the indentifier, e.g. `MIT` or `Apache`, similar to `SPDX-License-Identifier: MIT` in SPDX.
...
#### Deploying an EIP-721 NFT and signaling support for this EIP
