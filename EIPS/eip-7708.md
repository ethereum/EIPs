...
- Any nonzero-value-holding account closure, after any other logs created by EVM execution and the payment the [EIP-1559](./eip-1559.md) priority fee to the coinbase, in lexicographical order of closed account address
