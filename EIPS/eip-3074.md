...
`CALL_PRECOMPILE` requires the following arguments:
 ...
 - `sponsee` - 20 byte address of the sponsee;
...
The arguments to `CALL_PRECOMPILE` are encoded as `type || rlp([sponsee, nextra, gaslimit, to, valueTotal, valueSponseeMax, data, v, r, s])`.
