---
eip: <to be assigned>
title: Layer3 scaling standard
description: A primitive standard facilitating eternal upgradeability of smart contracts, by making storage slots dynamic; mitigating the need for redeployment of the proxy in case the storage structure changes
...
## Test Cases
Test cases are included in the reference implementation - [https://github.com/0xHashstack/Layer3-scaling-standard/blob/main/test/storageUpgradabilityTest.js](https://github.com/0xHashstack/Layer3-scaling-standard/blob/main/test/storageUpgradabilityTest.js)

## Reference Implementation
[https://github.com/0xHashstack/Layer3-scaling-standard](https://github.com/0xHashstack/Layer3-scaling-standard)



## Security Considerations
A storage selector clash occurs when two different storage slot address points to the same location. This has the unintended consequence of overriding data which is unintentional. This scenario is not possible with the diamondCut function prescribed in EIP-2535, because it uses the contract address of facets to generate the slot address.
