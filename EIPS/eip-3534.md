...
In case of reference to the genesis block, the number may be omitted.
...
Constrains the validity of a transaction by a chain context subclass referencing the [`beneficiary`](https://github.com/ethereum/yellowpaper/blob/41c1837f7b1ddcd65f135763c8e965146cd0ab70/Paper.tex#L336) address of the block including the transaction.
...
This is a scalar value equal to the maximum valid [`timestamp`](https://github.com/ethereum/yellowpaper/blob/41c1837f7b1ddcd65f135763c8e965146cd0ab70/Paper.tex#L345)  of a block header for a block including this transaction.
