...
1. A finance contract can only be initialized once from 
...
3. Every state-changing function of the smart contract only accept sender who owns soul-bound or account bound-token.
