...
<figure>
<img src="../assets/eip-5252/media/diagram.svg" alt="Diagram" style="width:100%">
...
#### Transition from token governance to credential-based governance

- pix on token governance
- Luna violating governance decision by owning most of the supply and barriers through staking
...
- Ferrari does not sell cars, they sell membership
    ...
    - Membership benefits and penalties(do not know cuz I do not own Ferrari)
    - Penalties
...
- Bored Ape Yacht Club(BAYC)
    ...
    - Benefit is the status(e.g. women buying birkin bags)
    - No related penalties on maintenance

#### Conclusion

- Projects based on this pattern should not sell ponzis, they should sell membership
    - Apply penalty on violating `Finance` contract (e.g. liquidation on loan contract)
