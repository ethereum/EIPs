...
author: Jan Smrža (@smrza), David Rábel (@rabeles11), Tomáš Janča <tomas.janca@jtbstorage.eu>, DOBBYLABS (@DOBBYLABS)
...
This proposal is a follow up to [EIP-4400](./eip-4400.md) and [EIP-4907](./eip-4907.md) and introduces additional upgrades for lending and borrowing which include:
...
**Every ERC-X compliant contract MUST implement the IERC-X interface. This extension is OPTIONAL for [EIP-721](./eip-721.md) contracts.**
```solidity
/**
...
**The Balance extension is OPTIONAL for ERC-X smart contracts. This gives the options to query amount of tokens user has.**
```solidity
/**
 * @title IERCXBalance
 * @dev See ---proposal_link---
...
**The Enumerable extension is OPTIONAL for ERC-X smart contracts. This allows to iterate over user balance.**
```solidity
/**
...
**The Terminable extension is OPTIONAL for ERC-X smart contracts. This allows to terminate the rent early if both parties agree.**
```solidity
/**
...
* [Main contract](../assets/eip-X/test/...)
* [Balance extension](../assets/eip-X/test/...)
* [Enumeration extension](../assets/eip-X/test/...)
* [Termination extension](../assets/eip-X/test/...)
* [Scenario combined of all extensions](../assets/eip-X/test/...)

## Reference Implementation
The reference implementation is available here:
* [Main contract](../assets/eip-X/contracts/...)
* [Balance extension](../assets/eip-X/contracts/...)
* [Enumeration extension](../assets/eip-X/contracts/...)
* [Termination extension](../assets/eip-X/contracts/...)
* [Solution combined of all extensions](../assets/eip-X/contracts/...)
