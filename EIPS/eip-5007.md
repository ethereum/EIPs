...
The **composable extension** is OPTIONAL for EIP-5007 smart contracts. This allows your NFT to be minted from an existing NFT or to merge two NFTs into one NFT.
