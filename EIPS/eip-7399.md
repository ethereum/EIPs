...
This EIP is a successor of [ERC-3156](./eip-3156.md). While not directly backwards compatible, a wrapper contract offering a EIP-XXXX external interface with liquidity obtained from an ERC-3156 flash `lender` is trivial to implement.
