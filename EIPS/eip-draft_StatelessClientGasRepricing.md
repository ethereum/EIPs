...
The gas cost of EVM opcodes `SLOAD` and `SSTORE` increases in order to accomodate extra bandwith required to propagate block proof together with the block
