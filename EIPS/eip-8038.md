...
| `CREATE_REGULAR` | Cost of  | 2,600 | TBD | TBD | `*CALL` opcodes, `BALANCE`, `SELFDESTRUCT`, `EXT*` opcodes, `CREATE`/ `CREATE2`, EOA delegations, contract creation txs and ETH transfers |
