...
1. we are still open to have co-author to collaborate, in particular, we are looking for co-authors who are experienced in application-layer standard design, or voting system application developer. 

2. We have two discussion destination: https://github.com/ethereum/EIPs/issues/1202 for long and more mature thoughts and t.me/erc1202 for real-time and less mature chat.
...
## Acknowledgement
We appreciate the advices and comments from @frozeman and @fulldecent.
...
- 2018-07-22: (@xinbenlv)Moved official discussion thread from [github issue](https://github.com/ethereum/EIPs/issues/1202) to [ethereum-magicians](https://ethereum-magicians.org/t/erc-1202-voting-standard-official-discussion-thread/670) - moved back pending community clarification(we prefer github issue, if possible).
- 2018-07-23: (@xinbenlv)
  - add co-author Yin Xu (@yingogobot)
  - add layout for a few applications and case studies for further drafting.
