...
description: Standardized format for messages being signed or hashed to follow
...
Test cases are included in the implementation linked below.
...
This EIP has significant ramifications, and touches on sensitive topics. As such, the EIP will use this section to define criteria for when the EIP can be considered accepted:
