...
1. **Current:** [Opaque `ByteList`](https://github.com/ethereum/consensus-specs/blob/67c2f9ee9eb562f7cc02b2ff90d92c56137944e1/specs/bellatrix/beacon-chain.md#custom-types) containing the transaction's original representation
...
| Transaction type | Native | Current | SSZ Union | Normalized | Union + Snappy | Norm + Snappy |
| - | :-: | :-: | :-: | :-: | :-: | :-: |
| `LegacyTransaction` | RLP | 106 bytes | 210 bytes | 272 bytes | 138 bytes | 195 bytes |
| [EIP-155](./eip-155.md) transaction | RLP | 108 bytes | 210 bytes | 272 bytes | 139 bytes | 194 bytes |
| [EIP-2930](./eip-2930.md) transaction | RLP | 111 bytes | 215 bytes | 272 bytes | 145 bytes | 194 bytes |
| [EIP-1559](./eip-1559.md) transaction | RLP | 117 bytes | 247 bytes | 272 bytes | 148 bytes | 194 bytes |
| [EIP-4844](./eip-4844.md) transaction | SSZ | 315 bytes | 315 bytes | 340 bytes | 186 bytes | 234 bytes |

- [Sample transactions (native)](../assets/eip-6404/tests/create_transactions.py)
