...
Additionally, `tx.payload.max_priority_fees_per_gas.blob` MUST be checked to be set to `0` if defined. This limitation ensures feature parity of SSZ transactions with RLP transactions and MAY be relaxed by a future EIP.
