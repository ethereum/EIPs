...
![Transaction SSZ merkle tree](../assets/eip-6404/images/transaction.png)
...
| Transaction type | Native | Current | SSZ Union | Normalized |
| - | :-: | :-: | :-: | :-: |
| `LegacyTransaction` | RLP | 106 bytes | 210 bytes | 276 bytes |
| [EIP-155](./eip-155.md) transaction | RLP | 108 bytes | 210 bytes | 276 bytes |
| [EIP-2930](./eip-2930.md) transaction | RLP | 111 bytes | 215 bytes | 276 bytes |
| [EIP-1559](./eip-1559.md) transaction | RLP | 117 bytes | 247 bytes | 276 bytes |
| [EIP-4844](./eip-4844.md) transaction | SSZ | 315 bytes | 315 bytes | 344 bytes |
...
Tests have been performed without compression.

SSZ generally encodes less compact than RLP. The normalized `Transaction` is larger than the SSZ Union due to the extra commitments for computed properties, and due to the extra SSZ nesting for reducing proof size (more variable-length offset tables).
