...
description: Allows exits to use the consolidation queue when it is shorter, democratizing access to an existing unintended feature that allows more efficient use of the churn, improving liquidity while preserving existing weak subjectivity security guarantees.
