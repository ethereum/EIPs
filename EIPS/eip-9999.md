...
description: Allows exits to use the consolidation queue, democratizing access to an existing unintended feature that allows more efficient use of the churn, improving liquidity while preserving security guarantees.
