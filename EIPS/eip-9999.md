...
Instruction-based architectures, such as Uniswap’s UniversalRouter, as well as contracts that use byte-level calldata compression, benefit from reduced gas usage and smaller bytecode size when parsing byte streams.
...
- Uniswap UniversalRouter Technical Reference: https://docs.uniswap.org/contracts/universal-router/technical-reference
