...
1. Check whether `T` can be decoded. If `T` cannot be decoded as any of the transaction types valid for the active fork, then jump to the next transaction, else continue with next step.
