...
[ERC-721](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md) and [ERC-1155](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1155.md), the ordering information of multiple
...
language. This illustrates the key difference between this standard and ERC-1155.
...
is kept in storage and hence additional storage than ERC-1155 is required.
