...
Additionally a requirement for code to be terminated by `STOP` (0x00) (or by other "terminating" opcodes, including `INVALID`, `RETURN`, `REVERT`, and `SELFDESTRUCT`) could be added. Note that the EIP-3540 forbids empty code section.
