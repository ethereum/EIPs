...
If it is unknown whether a contract has the `rootOwnerOf` function then the magic value must be compared to `0xcd740db5`.

`0xcd740db5` is equal to: `this.rootOwnerOf.selector ^ this.rootOwnerOfChild.selector ^ this.tokenOwnerOf.selector ^ this.ownerOfChild.selector;`
...
`0xcd740db5` is equal to: `this.rootOwnerOf.selector ^ this.rootOwnerOfChild.selector;`
