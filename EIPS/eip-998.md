...
The reason for this is that these functions do not explicitly specify which token owns the token to be transferred. [See the rational section for more information about this.](#explicit-transfer-parameters)
