...
1. [ERC721 top-down composable tokens](#erc721-top-down-composable) that receive, hold and transfer ERC721 tokens
2. Optional top-down enumeration of child ERC721 tokens
3. ERC20 top-down composable tokens that receive, hold and transfer ERC20 tokens
4. ERC721 bottom-up composable tokens
...
ERC721 bottom-up composable contracts record the owning address of a token and the parent tokenId if any.
...
interface ERC998ERC721BottomUp {
  ...
  function tokenOwnerOf(uint256 _tokenId) external view returns (address tokenOwner, uint256 parentTokenId, bool isParent);
