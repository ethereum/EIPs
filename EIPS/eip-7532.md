...
As the ethereum network matures and throughput and age increases larger measurement units are required. The generation is based off of the average time to activate a validator on the beacon chain and can be used to show long term time measurements, such as...

1. Long term validator analytics (e.g. operating time, attestation performance)
2. Average block utilization.
3. Average network health (e.g orphaned and missed slots)
