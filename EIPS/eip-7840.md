...
Although maintaining the blob parameters in the consensus client is desirable, we acknowledge that execution clients also require these values for various activities.
For example, the `eth_feeHistory` RPC method returns a
