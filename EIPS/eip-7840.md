...
Clients must configure the target, max and updateFraction per-fork. The behavior
...
good middle ground. Additionally, the `updateFraction` parameter was added to adjust the responsiveness of blob gas pricing per fork.
