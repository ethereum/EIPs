...
Remark: Ethereum Yellow Paper introduced the _max gas refunded_ in [(65)](https://github.com/ethereum/yellowpaper/blob/constantinople/Paper.tex#L648) as `gas_used // 2`. Here we
