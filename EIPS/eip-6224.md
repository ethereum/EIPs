...
The EIP standardizes the management of smart contracts within the decentralized application ecosystem. It enables protocols to become agile and reduces their maintenance threshold. This EIP additionally introduces a smart contract dependency injection mechanism to audit dependency usage, to aid larger composite projects.
...
The `ContractsRegistry` SHOULD be the topmost smart contract in the system. It SHOULD NOT depend on other contracts. The extensions of this EIP SHOULD add proper access control checks to the described non-view methods. 
