...
An good example is the JVM.  Subroutines are implemented as class methods, and calls and returns are handled with the INVOKE* and RETURN* family of instructions, which handle return addresses on an internal stack.
