...
#### The Fundamental Problem: Dynamic Jumps
...
- Extracting the control flow graph
...
This Information proposal specificies no changes to the protocol.  Therefore it has no direct security implications.
