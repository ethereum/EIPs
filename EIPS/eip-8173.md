---
eip: 8173
title: EVM Control Flow — Foundational Concepts & Context
...
Among the most imporant reasons to traverse the control flow of a program is to extract the control flow graph.  The EVM makes this quadratically difficult due to it's dynamic control flow. 
