...
```solidity
/// @title ERC-XYZ Emotable Extension for Non-Fungible Tokens
...
Tests are included in [`emotableRepository.ts`](../assets/eip-XYZ/test/emotableRepository.ts).
...
See [`EmotableRepository.sol`](../assets/eip-XYZ/contracts/EmotableRepository.sol).
