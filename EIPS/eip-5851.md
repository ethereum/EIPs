...
- ZK-ID NFT: NFT representing the self-sovreign federated identity for providing ZK based Proof of Identity from trusted public certificates (e.g national identity cards, password and eSIM), and thus can be used to represents as world-wide-web consortium DID specifications etc.
