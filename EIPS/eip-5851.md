...
The [interface](../assets/eip-5851/contracts/interfaces/EIP5851.sol) is divided into two separate implementations:

- [EIP-5851 Verifier](../assets/eip-5851/contracts/ERC5851Verifier.sol) is a simple modifier that needs to be imported by functions that are to be only called by holders of the SBT certificates. This is a wrapper contract of this EIP's `verify()` method and can be implemented for arbitrary types of contract.
