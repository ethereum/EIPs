...
category: ERC
created: 2022-10-18
requires: 721, 1155, 3643, 5114, 1167, 1967
---
## Abstract
...
Here we show the example real-life implementation scenario of how the ERC5851 based identity issuer can be used to access a particular DeFI protocol that includes a modifier to check the possession of the given certificate.
