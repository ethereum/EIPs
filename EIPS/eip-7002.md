...
def insert_exit_to_queue(address: source_address, Bytes48: validator_pubkey):
    ...
    sstore(EXIT_PRECOMPILE_ADDRESS, queue_storage_slot + 1, validator_pubkey[0:32])
    sstore(EXIT_PRECOMPILE_ADDRESS, queue_storage_slot + 2, validator_pubkey[32:48])
...
for i in range(num_exits_to_dequeue):
    ...
    source_address = address(SLOAD(EXIT_PRECOMPILE_ADDRESS, queue_storage_slot)[0:20]
    validator_pubkey = (
