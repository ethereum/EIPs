...
In-EVM emission sites for the [EIP-7708](./eip-7708.md) transfer log (value-moving `CALL`, `SELFDESTRUCT`, `CREATE` / `CREATE2`) and any burn-log charges are specified in [EIP-7708](./eip-7708.md).
