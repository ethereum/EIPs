...
- `TX_BASE_COST = 12,000` — ECDSA recovery, the sender account's access and write, and the inclusion of the transactio in the block (which is transient and expires with history).
