...
2. **Payload-size bounds:** Per [EIP-7984](./eip-7984.md) the execution payload cap is `MAX_RLP_BLOCK_SIZE = 10,485,760 - 2,097,152 = 8,388,608` bytes. Payload size, not gas, may become the dominant block-size constraint at high gaslimits.
...
13. Perfnet stress
    - Fill block with minimal 4,500-gas tx and 6,000-gas ETH transfers; confirm gas vs byte-size binding per [EIP-7984](./eip-7984.md).
