...
This standard proposes an extension to 721 Non-Fungible Tokens (NFTs) to construct reference relationships among NFTs.

## Abstract
This standard is an extension of 721. It proposes two referrable indicators, referring and referred, and a time-based indicator createdTimestamp. The relationship between each NFT forms a Directed acyclic graph (DAG). The standard allows users to query, track and anlayse their relationships.
...
This standard can be fully 721 compatible by adding an extension function set.
