...
1. Update the [EIP-170](./eip-170.md) contract code size limit of 24KB (`0x6000` bytes) to 64KB (`0x10000` bytes).
...
3. Update the [EIP-3860](./eip-3860.md) contract initcode size limit of 48KB (`0xc000` bytes) to 128KB (`0x10000` bytes).
...
1. Any account created or updated after `FORK_BLKNUM` should additionally have its codesize written into the account tuple.
