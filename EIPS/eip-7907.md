...
| Warm account and code   | No change to existing gas schedule. `WARM_STORAGE_READ_COST=100` | `CALL`, `STATICCALL`, `DELEGATECALL`, `CALLCODE` or `EXTCODECOPY` previously in the txn (opcodes that load contract code) |
