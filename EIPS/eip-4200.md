...
Because the destinations are validated upfront, the cost of these instructions are less than their dynamic counterparts: `RJUMP` should cost 2, and `RJUMPI` and `RJUMPV` should cost 4. This is a reduction of 2 gas, compared to `JUMP` and `JUMPI`.
