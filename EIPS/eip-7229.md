...
NOTE: To push a zero value onto the stack without abusing the `RETURNDATASIZE` opcode, the above code utilizes [ERC-3855](./eip-3855.md). It achieves this by using the `PUSH0` instruction to push the zero value.
...
Test cases are available at [https://github.com/xiaobaiskill/minimal-upgradable-proxy/tree/main/test](../assets/eip-7229/test)
