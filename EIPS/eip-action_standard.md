...
Test cases are include in `../assets/eip-action_standard/`.

## Reference Implementation

Implementations for both standard contracts and EIP-2535 Diamonds are included in `../assets/eip-action_standard/`.
