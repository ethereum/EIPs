---
eip: 7605
title: pERC20 - Privacy-Native Fungible Tokens
description: Privacy-native fungible token interface on EVM using ZK-UTXO notes
author: PERC20 Labs (@PERC20Labs)
discussions-to: https://ethereum-magicians.org/t/perc20-privacy-native-fungible-token/1
status: Draft
...
**Note ciphertext format**: This standard does not embed a specific note-plaintext layout into its byte-level invariants, but implementations MUST fix one and document it. The reference implementation uses the Orchard-style field sizes defined in [Zcash Protocol Specification §7.5 Action Description Encoding and Consensus](https://zips.z.cash/protocol/protocol.pdf#actionencodingandconsensus):
...
This layout is derived from the Orchard Action primary inputs in [Zcash Protocol Specification §4.18.4 Action Statement (Orchard)](https://zips.z.cash/protocol/protocol.pdf#actionstatement) (`anchor`, net value commitment `cv_net`, `nf_old`, randomized key `rk`, output commitment `cmx`). `pERC20` makes two deliberate deviations for compliance and a unified verification path:
...
The reference implementation in the [PERC20](https://github.com/PERC20Labs/PERC20) repository includes:
...
See [docs/e2e-report.md](https://github.com/PERC20Labs/PERC20/blob/main/docs/e2e-report.md) for scenario-to-spec mapping and findings.

## Reference Implementation

Reference implementation available in the [reference repository](https://github.com/PERC20Labs/pERC20_):

- [`contracts/ptoken/PERC20.sol`](https://github.com/PERC20Labs/pERC20_/blob/main/contracts/ptoken/PERC20.sol) — normative asset contract (`IPERC20` reference)
...
Please cite this document as: PERC20 Labs, "[ERC-7605](./erc-7605.md): Privacy-Native Fungible Tokens," *Ethereum Improvement Proposals*, June 2026.
