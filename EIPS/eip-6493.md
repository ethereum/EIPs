...
The values `0x00` and `0x01` are marked as reserved [EIP-2718](./eip-2718.md) transaction types.
...
Note that `0x19` is reserved to prevent collision with [EIP-191](./eip-191.md) signed data.
