...
See [Solmate ERC6426](https://github.com/Rari-Capital/solmate/pull/88): a minimal and opinionated implemenation of the standard with hooks for developers to easily insert custom logic into deposits and withdrawals.
