...
and forces each protocol to implement their own adapters which are error prone and waste development resources.
...
MUST return the initial share price when empty.
