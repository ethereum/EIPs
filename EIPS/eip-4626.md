...
Total number of underlying assets that can be deposited in `to` vault balance, where `to` corresponds to the input parameter of a `deposit` call.
...
Total number of underlying shares that `to` can mint, where `to` corresponds to the input parameter of a `mint` call.
...
Total number of underlying assets that `from` can withdraw, where `from` corresponds to the input parameter of a `withdraw` call.
...
Total number of underlying shares that `from` can redeem, where `from` corresponds to the input parameter of a `redeem` call.
