---
eip: 10
title: EIP Code of Conduct
status: Draft
type: Meta
author: YazzyYaz <yaz.khoury@gmail.com>
created: 2019-12-03
---
This Code of Conduct EIP has been taken directly from [Contributor Covenant Open Source Code of Conduct](https://www.contributor-covenant.org/)
under the [CC-By-4.0 License](https://github.com/ContributorCovenant/contributor_covenant/blob/release/LICENSE.md)

This Code of Conduct EIP applies to all members wishing to participate in the EIP process:

1) EIP Editors
2) Hardfork Coordinators
3) EIP Authors
4) Ethereum Community Members Participating in the EIP Process.
