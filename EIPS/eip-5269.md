...
description: An interface returning whether certain interface specified in ERC number and minor extension is supported by a smart contract to a given caller.
...
of method signature, such as EIP-712 or EIP-5453 related to data format and signature algorithms.
