...
- [EIP-1109](https://eips.ethereum.org/EIPS/eip-1109): PRECOMPILEDCALL opcode (Remove CALL costs for precompiled contracts) - requirement of EIP-1962
...
- [EIP-1962](https://github.com/ethereum/EIPs/pull/1962): EC arithmetics and pairings with runtime definitions - replaces EIP-1829
- [EIP-2026](https://github.com/ethereum/EIPs/pull/2026): State Rent H - Fixed Prepayment for accounts
- [EIP-2027](https://github.com/ethereum/EIPs/pull/2027): State Rent C - Net contract size accounting
- [EIP-2028](https://github.com/ethereum/EIPs/pull/2028): Calldata gas cost reduction
- [EIP-2029](https://github.com/ethereum/EIPs/pull/2029): State Rent A - State counters contract - requirement of EIP-2031
- [EIP-2031](https://github.com/ethereum/EIPs/pull/2031): State Rent B - Net transaction counter
- [EIP-2035](https://github.com/ethereum/EIPs/pull/2035): Stateless clients for contract storage - Gas repricing
