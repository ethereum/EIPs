...
author: IfDefElse <ifdefelse@protonmail.com>, Greg Colvin <greg@colvin.org>, Andrea Lanfranchi (@AndreaLanfranchi), Michael Carter (@bitsbetrippin)
...
The Ethereum blockchain is -- by design -- secured by a geographically-distributed community of miners operating primarily on commodity GPUs.  To this end the  Ethash function was originally "ASIC-resistant," but that is no longer the case.
