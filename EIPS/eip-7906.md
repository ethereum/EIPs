...
| 0x08    | index in `slots_changed`      | `slot_value_before` - the value of the slot before execution                |
| 0x09    | index in `slots_changed`      | `slot_value_after` - the value of the slot after execution                  |
