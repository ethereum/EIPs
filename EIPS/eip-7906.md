...
| 0x15    | must be 0                     | `gas_payer_address` - the address charged the gas pre-charge; `tx.origin` for legacy transactions, the `APPROVE_PAYMENT` target for [EIP-8141](./eip-8141.md) transactions |
