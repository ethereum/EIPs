...
| 0x06    | index in `slots_changed`    | `slot_value_before` -  the balance of the slot before execution             |
| 0x07    | index in `slots_changed`    | `slot_value_after` - the balance of the slot after execution                |
