...
author: Undisclosed Author, Qi Zhou <qizhou@quarkchain.org>
discussions-to: TBD
...
To solve all these problems, this ERC proposes a new type of account - name-owned account (NOA). An NOA has
1. a name for social identity; and
2. an address derived from the name to receive tokens; and
3. an owner/owners of the name that is able to transfer the token.
...
Using NOA as social identity instead of EOA/CA brings huge benefits for users:
...
### Example Contracts for ERC721 and ERC20 (ERC721NOA and ERC20NOA)
The example contracts can be found at [NameOwnedAccount.sol](https://github.com/dongshu2013/b23/blob/main/contracts/contracts/identity/NameOwnedAccount.sol), [ERC721NOA.sol](https://github.com/dongshu2013/b23/blob/main/contracts/contracts/token/ERC721/ERC721NOA.sol), [ERC20NOA.sol](https://github.com/dongshu2013/b23/blob/main/contracts/contracts/token/ERC20/ERC20NOA.sol).
