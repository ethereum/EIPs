...
Further, every contractsURI SHOULD include at least the contract inheriting the EIP4824 interface.
...
```
{
    ...
    "contracts": [
        ...
        }
        {
            ...
            "description": "<description, e.g. EIP4824 registration contract>"
        }
    ]
}
```
