...
- **Recommended**: 4 TB NVMe M.2 drive with:
  - **Sequential R/W**: At least ~1,000 MB/s
  - **Random 4K R/W**: At least ~50,000 IOPS
- **Verifying IO Performance**: You can use the following command to benchmark your local storage IO speeds:
  ```
