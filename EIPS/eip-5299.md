...
## Specification
This EIP is an extension of [EIP-2535](./eip-2535.md), adding a mechanism that maintains the old data points while updating the implementation.
