...
The execution order of revelations in block N is determined by `RANDAO`. The shuffle seed is independent of revelation payload contents, preventing builders from manipulating the execution order through strategic reveal or non-reveal of their own commitments.
