...
category: Core
created: 2026-06-11
requires: 2200, 2929, 3529, 3607, 6780, 7702
---
...
- storing a new distinct bytecode blob = `0`, because `SETCODEFROM` reuses the source's existing or pending `codeHash => code` mapping
