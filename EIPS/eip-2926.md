...
### Compatibility with subroutines

[EIP-2315](https://eips.ethereum.org/EIPS/eip-2315) proposes subroutine features for the EVM. This spec is compatible with the [current](https://github.com/ethereum/EIPs/blob/e8accf22cdc5562d6982c560080c6cd6b7f94867/EIPS/eip-2315.md) version of the EIP. However one of the proposed [modifications](https://ethereum-magicians.org/t/eip-2315-simple-subroutines-for-the-evm-analysis/4229) would require a change in the code merkleization spec. Specifically disallowing jumps via JUMP and JUMPI in and out of subroutines would require chunks to encode information about the subroutine they're in for safe stateless validation. We're monitoring the status of EIP-2315 and will make adjustments to this EIP as necessary.
