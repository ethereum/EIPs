...
Some basic tests can be found on [`Uniswap V2`](../assets/eip-2612/UniswapV2ERC20.spec.ts).

## Reference Implementation

[`UniswapV2ERC20.sol`](../assets/eip-2612/UniswapV2ERC20.sol)
