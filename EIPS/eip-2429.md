...
A user can configure a recovery by providing a secret, a list of addresses with a weight. The secret should be semi-private information, such as a "randomly ordered personal information + secret answer", or user biometric data, or even a password. The threshold is a constant `THRESHOLD = 10^18`.
