...
eip: <to be assigned>
title: <EIP title>
author: <list of authors' names and optionally, email addresses or Github usernames e.g. FirstName LastName (@GitHubUsername) or FirstName LastName <foo@bar.com>>
