---
eip: 5187
title: Extending ERC-1155 with rentable usage rights
description: This proposal is an extension of EIP-1155 to achieve the separation of NFT ownership and usage rights. It mainly acts on NFTs with use-value, not just collectible value. The proposal would much reduce the inconvenience and high cost of NFT transfer and open up a trading market for NFT use rights.
