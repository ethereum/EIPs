...
**Testing Environment**: Tests are executed against an op-geth client built from [yhl125/op-geth](https://github.com/yhl125/op-geth/tree/feat/minimal-ntt-precompile) with integrated NTT precompile support.
...
2. **Configure RPC endpoint**:
   The tests use `RPC_URL` in .env to connect to the op-geth node.
...
- [EIP-7885: Number Theoretic Transform Precompiles](../../../EIPS/eip-7885.md)
