 ...
 * account.
 */
abstract contract ERC721PCloneable is ERC721P, IERC721PCloneable {
    ...
    function supportsInterface(bytes4 interfaceId) public override virtual view returns (bool) {
        return interfaceId == type(IERC721PCloneable).interfaceId || super.supportsInterface(interfaceId);
    }
