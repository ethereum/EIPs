...
- [Fail `BLS12_G1MSM` Machine-readable data](fail-mul_G1_bls.json)
- [Fail `BLS12_G2MSM` Machine-readable data](fail-mul_G2_bls.json)
...
- [Fail `BLS12_PAIRING` Machine-readable data](fail-pairing_check_bls.json)
