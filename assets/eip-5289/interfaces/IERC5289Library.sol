...
interface IERC5289Library is IERC165 {
    ...
    function legalDocument(uint16 documentId) external view returns (bytes memory);
    ...
    function signDocument(address signer, uint16 documentId, bytes memory signature) external;
}
