"""Tests for the reference validator (validator.py).

Shares the vectors of test_overflow.py, run with STACK_LIMIT reduced
...
"""
import validator as ref
from test_overflow import TESTS
