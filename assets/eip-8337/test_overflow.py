"""Tests for the bounds-proving validator (overflow_validator.py).

These are the shared vectors: test_validator.py runs the same TESTS
...
"""
import overflow_validator as ref
