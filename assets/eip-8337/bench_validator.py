"""Benchmarks for the reference validator (validator.py).
...
above that.  The bounds-proving validator (overflow_validator.py) runs
...
import overflow_validator as full
import validator as mv
from bench_overflow import call_chain, jumpi_diamonds, recursion_pump, straight_line
