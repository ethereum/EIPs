...
interface IERC5851{
    ...
    * @param description additional information about claim details.
    ...
    // Values represent the various attributes that users can define in the claims structure on-chain:
    ...
    **/
    function changeStandardClaim(uint256 SBTID, Claims[] memory _claims) external returns (bool);
...
// Events
    ...
    */
    event StandardChanged(uint256 SBTID, Claims[] _claims);
