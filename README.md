...
The EIP consists of two interfaces which fulfill different roles, found here as `IERC1155` and `IERC1155TokenReceiver`. Only `IERC1155` is required for a contract to be ERC1155 compliant. The bas[...]Bu içeriği `README.md` dosyanıza yapıştırabilir ve yeniden deneyebilirsiniz.Bu içeriği `README.md` dosyanıza yapıştırabilir ve yeniden deneyebilirsiniz.
sections:
  - title: Core
    contracts:
      - IERC1155
