...
| [100](EIPS/eip-100.md)                             | Change difficulty adjustment to target mean block time including uncles                      | Vitalik Buterin                            | Core       | Final    |
| [137](EIPS/eip-137.md)                             | Ethereum Domain Name Service - Specification                                                 | Nick Johnson                               | ERC        | Final    |
| [140](EIPS/eip-140.md)                             | REVERT instruction in the Ethereum Virtual Machine                                           | Alex Beregszaszi, Nikolai Mushegian        | Core       | Final    |
...
| [196](EIPS/eip-196.md)                             | Precompiled contracts for addition and scalar multiplication on the elliptic curve alt_bn128 | Christian Reitwiessner                     | Core       | Final    |
| [197](EIPS/eip-197.md)                             | Precompiled contracts for optimal Ate pairing check on the elliptic curve alt_bn128          | Vitalik Buterin, Christian Reitwiessner    | Core       | Final    |
| [198](EIPS/eip-198,md)                             | Precompiled contract for bigint modular exponentiation                                       | Vitalik Buterin                            | Core       | Final    |
| [211](EIPS/eip-211.md)                             | New opcodes: RETURNDATASIZE and RETURNDATACOPY                                               | Christian Reitwiessner                     | Core       | Final    |
| [214](EIPS/eip-214.md)                             | New opcode STATICCALL                                                                        | Vitalik Buterin, Christian Reitwiessner    | Core       | Final    |
...
| [649](EIPS/eip-649.md)                             | Metropolis Difficulty Bomb Delay and Block Reward Reduction                                  | Afri Schoedon, Vitalik Buterin             | Core       | Final    |
| [658](EIPS/eip-658.md)                             | Embedding transaction return data in receipts                                                | Nick Johnson                               | Core       | Final    |
