...
<template>
    ...
    <div id="docsearch" style="margin-right: 1em;">
        <form type="button" class="DocSearch DocSearch-Button" aria-label="Search">
            <span class="DocSearch-Button-Container">
                ...
                <input class="DocSearch-Button-Placeholder" id="searchitem" v-model="searchitem" placeholder="Enter search here..."/>
