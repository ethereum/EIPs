...
Leverage a mixture of the existing snapshot off-chain voting with a L2 (optimism) smart contract to support on-chain voter dilution.

- The snapshot API will be used to retrieve proposals and enable voting on the staking.synthetix.io dAPP.
- L2 smart contract will be used to store the results of each Spartan Council election and will be used to enable voter diluton.
