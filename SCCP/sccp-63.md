...
The iETH price limits were increased in [SCCP-18] to support the iETH staking rewards incentives trial. This SCCP proposes to remove the iETH limits as iETH has frozen at the upper limit and the new staking rewards contract has been upgraded to allow frozen synths to be purged and recovered from the contract itself.
