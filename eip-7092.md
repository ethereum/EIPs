...
interface IERC {
    ...
    */
    ...
    /**
    * @notice Returns the issue volume (total debt amount). It is recommanded to express the issue volume in denomination unit.
    ...
    */
    ...
    /**
    * @notice Returns the bond interest rate. It is recommanded to express the interest rate in basis point unit.
    ...
    */
    ...
    /**
    * @notice Returns the principal of an account. It is recommanded to express the principal in denomination unit.
